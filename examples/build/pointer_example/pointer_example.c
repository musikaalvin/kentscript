...
ks_val_t ptr1 = {.tag = KS_T_INT, .as.i = 4096LL};
ks_val_t ptr2 = {.tag = KS_T_INT, .as.i = 256LL};
ks_val_t distance;

void _ks_init_globals(void) {
    distance = ks_v_sub(ptr1, ptr2);
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    _ks_init_globals();
#line 6 "examples/pointer_example.ks"
    ks_val_print(ks_str(_ks_concat("Pointer 1: ", ks_val_to_str(ptr1)))); printf("\n");
#line 7 "examples/pointer_example.ks"
    ks_val_print(ks_str(_ks_concat("Pointer 2: ", ks_val_to_str(ptr2)))); printf("\n");
#line 8 "examples/pointer_example.ks"
    ks_val_print(ks_str(_ks_concat("Distance: ", ks_val_to_str(distance)))); printf("\n");
#line 10 "examples/pointer_example.ks"
    ks_val_t int_size = KS_INT(4LL);
#line 11 "examples/pointer_example.ks"
    ks_val_t long_size = KS_INT(8LL);
#line 12 "examples/pointer_example.ks"
    ks_val_t ptr_size = KS_INT(8LL);
#line 14 "examples/pointer_example.ks"
    ks_val_print(ks_str(_ks_concat("sizeof(int) = ", ks_val_to_str(int_size)))); printf("\n");
#line 15 "examples/pointer_example.ks"
    ks_val_print(ks_str(_ks_concat("sizeof(long) = ", ks_val_to_str(long_size)))); printf("\n");
#line 16 "examples/pointer_example.ks"
    ks_val_print(ks_str(_ks_concat("sizeof(ptr) = ", ks_val_to_str(ptr_size)))); printf("\n");
    return 0;
}