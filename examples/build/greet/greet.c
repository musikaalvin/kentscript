...
void greet(ks_val_t name1, ks_val_t name2, ks_val_t name3, ks_val_t name4);

#line 3 "examples/greet.ks"
void greet(ks_val_t name1, ks_val_t name2, ks_val_t name3, ks_val_t name4) {
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("\nHello ", ks_val_to_str(name1)), ", "), ks_val_to_str(name2)), ", "), ks_val_to_str(name3)), " "), ks_val_to_str(name4)), " this is kentscript by pyLord! "))); printf("\n");
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
#line 9 "examples/greet.ks"
    greet(ks_str(("Reagan")), ks_str(("Emmanation")), ks_str(("moon-bot12")), ks_str(("chàos")));
    return 0;
}