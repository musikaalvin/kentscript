...
#line 5 "examples/progress_animated.ks"
    ks_val_print(ks_str(_ks_colorize("36", "=== Animated Progress Bar Demo ==="))); printf("\n");
#line 6 "examples/progress_animated.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 9 "examples/progress_animated.ks"
    ks_val_print(ks_str(_ks_colorize("33", "Loading..."))); printf("\n");
    for (long long i = 0; i < 101; i++) {
    long long bar = 0;
    printf("%s", _ks_concat("\r", ks_val_to_str(ks_int(bar))));
    (fflush(stdout), 0);
    (system_time_sleep(0.03), 0);
}
#line 16 "examples/progress_animated.ks"
ks_val_print(ks_str(_ks_colorize("32", " Done!"))); printf("\n");
#line 17 "examples/progress_animated.ks"
ks_val_print(ks_str("")); printf("\n");
#line 20 "examples/progress_animated.ks"
ks_val_print(ks_str(_ks_colorize("33", "Processing..."))); printf("\n");
for (long long i = 0; i < 101; i++) {
long long bar = 0;
printf("%s", _ks_concat("\r", ks_val_to_str(ks_int(bar))));
(fflush(stdout), 0);
(system_time_sleep(0.02), 0);
}
#line 27 "examples/progress_animated.ks"
ks_val_print(ks_str(_ks_colorize("32", " Complete!"))); printf("\n");
#line 28 "examples/progress_animated.ks"
ks_val_print(ks_str("")); printf("\n");
#line 31 "examples/progress_animated.ks"
ks_val_print(ks_str(_ks_colorize("33", "Hacking..."))); printf("\n");
for (long long i = 0; i < 101; i++) {
long long bar = 0;
printf("%s", _ks_concat("\r", ks_val_to_str(ks_int(bar))));
(fflush(stdout), 0);
(system_time_sleep(0.025), 0);
}
#line 38 "examples/progress_animated.ks"
ks_val_print(ks_str(_ks_colorize("32", " Access Granted!"))); printf("\n");
return 0;
}