...
#line 4 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("31", "This is red text"))); printf("\n");
#line 5 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("32", "This is green text"))); printf("\n");
#line 6 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("34", "This is blue text"))); printf("\n");
#line 7 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("33", "This is yellow text"))); printf("\n");
#line 8 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("36", "This is cyan text"))); printf("\n");
#line 9 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("35", "This is magenta text"))); printf("\n");
#line 10 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("37", "This is white text"))); printf("\n");
#line 13 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("1", _ks_colorize("31", "Bold red")))); printf("\n");
#line 16 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("43", _ks_colorize("30", "Black on yellow")))); printf("\n");
#line 19 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_colorize("1", _ks_colorize("4", _ks_colorize("32", "Bold underlined green"))))); printf("\n");
#line 22 "examples/progress2.ks"
    ks_val_print(ks_str(_ks_concat(_ks_colorize("31", "Red"), " - Normal text"))); printf("\n");
    return 0;
}