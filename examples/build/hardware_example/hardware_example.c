...
void _ks_init_globals(void) {
    cpu_count = _ks_get_cpu_count(hardware);
    page_size = _ks_get_page_size(hardware);
    kernel = _ks_get_kernel_version(hardware);
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    _ks_init_globals();
#line 9 "examples/hardware_example.ks"
    ks_val_print(ks_str("=== Hardware Information ===")); printf("\n");
#line 10 "examples/hardware_example.ks"
    ks_val_print(ks_str(_ks_concat("CPUs: ", ks_val_to_str(cpu_count)))); printf("\n");
#line 11 "examples/hardware_example.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Page Size: ", ks_val_to_str(page_size)), " bytes"))); printf("\n");
#line 12 "examples/hardware_example.ks"
    ks_val_print(ks_str(_ks_concat("Kernel: ", ks_val_to_str(kernel)))); printf("\n");
#line 15 "examples/hardware_example.ks"
    long long cpu_info = _ks_get_cpu_info(hardware);
#line 16 "examples/hardware_example.ks"
    ks_val_print(ks_str("\n=== CPU Details ===")); printf("\n");
#line 17 "examples/hardware_example.ks"
    ks_val_print(ks_str(_ks_str_int(cpu_info))); printf("\n");
#line 20 "examples/hardware_example.ks"
    long long mem = _ks_get_memory_info(hardware);
#line 21 "examples/hardware_example.ks"
    ks_val_print(ks_str("\n=== Memory Info ===")); printf("\n");
#line 22 "examples/hardware_example.ks"
    ks_val_print(ks_str(_ks_str_int(mem))); printf("\n");
#line 25 "examples/hardware_example.ks"
    long long thermal = _ks_get_thermal(hardware);
#line 26 "examples/hardware_example.ks"
    ks_val_print(ks_str("\n=== Thermal Info ===")); printf("\n");
#line 27 "examples/hardware_example.ks"
    ks_val_print(ks_str(_ks_str_int(thermal))); printf("\n");
#line 30 "examples/hardware_example.ks"
    long long net = _ks_get_network_stats(hardware);
#line 31 "examples/hardware_example.ks"
    ks_val_print(ks_str("\n=== Network Stats ===")); printf("\n");
#line 32 "examples/hardware_example.ks"
    ks_val_print(ks_str(_ks_str_int(net))); printf("\n");
#line 35 "examples/hardware_example.ks"
    long long disk = _ks_get_disk_stats(hardware);
#line 36 "examples/hardware_example.ks"
    ks_val_print(ks_str("\n=== Disk Stats ===")); printf("\n");
#line 37 "examples/hardware_example.ks"
    ks_val_print(ks_str(_ks_str_int(disk))); printf("\n");
#line 45 "examples/hardware_example.ks"
    ks_val_print(ks_str("\n✓ Hardware info module loaded successfully")); printf("\n");
    return 0;
}