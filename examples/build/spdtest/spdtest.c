...
int main(int argc, char** argv) {
    ...
    _ks_init_globals();
    while (ks_v_bool(ks_bool(ks_v_cmp(i, KS_INT(1000000LL)) < 0))) {
        i = ks_v_add(i, KS_INT(1LL));
    }
#line 8 "examples/spdtest.ks"
    double end = ks_time_seconds();
#line 9 "examples/spdtest.ks"
    ks_val_print(ks_str("Loop finished!")); printf("\n");
#line 10 "examples/spdtest.ks"
    ks_val_print(ks_str("Final value of i (should be 1,000,000):")); printf("\n");
#line 11 "examples/spdtest.ks"
    ks_val_print(i); printf("\n");
#line 12 "examples/spdtest.ks"
    ks_val_print(ks_str("Time taken (seconds):")); printf("\n");
#line 13 "examples/spdtest.ks"
    ks_val_print(ks_v_sub(ks_flt(end), ks_flt(start))); printf("\n");
    return 0;
}