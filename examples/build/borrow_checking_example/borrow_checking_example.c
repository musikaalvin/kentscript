...
ks_val_t data = {.tag = KS_T_INT, .as.i = 42LL};
ks_val_t read1;
ks_val_t read2;
...
int main(int argc, char** argv) {
    ...
    _ks_init_globals();
#line 8 "examples/borrow_checking_example.ks"
    ks_val_print(ks_str(_ks_concat("Value 1: ", ks_val_to_str(read1)))); printf("\n");
#line 9 "examples/borrow_checking_example.ks"
    ks_val_print(ks_str(_ks_concat("Value 2: ", ks_val_to_str(read2)))); printf("\n");
#line 12 "examples/borrow_checking_example.ks"
    ks_val_t mut_data = KS_INT(100LL);
#line 13 "examples/borrow_checking_example.ks"
    ks_val_print(ks_str(_ks_concat("Modified: ", ks_val_to_str(mut_data)))); printf("\n");
#line 15 "examples/borrow_checking_example.ks"
    ks_val_print(ks_str("Borrow checking complete")); printf("\n");
    return 0;
}