...
static Point_t* __new_Point__(long long x, long long y) {
    Point_t* self = (Point_t*)malloc(sizeof(Point_t));
    self->__class__ = "Point";
    self->__attr_count__ = 0;
    memset(self->__attr_is_str__, 0, sizeof(self->__attr_is_str__));
    self->__attr_names__[0] = "x";
    self->__attrs__[0] = (void*)(uintptr_t)(long long)(x);
    self->__attr_is_str__[0] = 0;
    self->__attr_count__ = 1;
    self->__attr_names__[1] = "y";
    self->__attrs__[1] = (void*)(uintptr_t)(long long)(y);
    self->__attr_is_str__[1] = 0;
    self->__attr_count__ = 2;
    return self;
}

static char* __get_Point_attr__(Point_t* self, const char* name) {
...
static long long __get_Point_attr_num__(Point_t* self, const char* name) {
    for (int i = 0; i < self->__attr_count__; i++) {
        if (strcmp(self->__attr_names__[i], name) == 0) {
...
static void __set_Point_attr__(Point_t* self, const char* name, long long value) {
    for (int i = 0; i < self->__attr_count__; i++) {
        if (strcmp(self->__attr_names__[i], name) == 0) {
...
static char* __method_Point_to_string__(Point_t* self) {
    return _ks_concat(_ks_concat(_ks_concat(_ks_concat("Point(", ks_val_to_str(ks_int(__get_Point_attr_num__(self, "x")))), ","), ks_val_to_str(ks_int(__get_Point_attr_num__(self, "y")))), ")");
}


int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
#line 6 "examples/arrays.ks"
    ks_val_print(ks_str("=== Array Creation ===")); printf("\n");
#line 9 "examples/arrays.ks"
    ks_array empty = { .data = NULL, .length = 0 };
#line 10 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("Empty: ", _ks_json_stringify(ks_arr(&empty))))); printf("\n");
#line 13 "examples/arrays.ks"
...
#line 14 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("Numbers: ", _ks_json_stringify(ks_arr(&numbers))))); printf("\n");
#line 17 "examples/arrays.ks"
    static ks_val_t _arr_mixed[] = {(ks_val_t){.tag=KS_T_INT,.as.i=1LL}, (ks_val_t){.tag=KS_T_STR,.as.s=(char*)"hello"}, (ks_val_t){.tag=KS_T_BOOL,.as.b=1}, (ks_val_t){.tag=KS_T_FLT,.as.f=3.14}};
    ks_array mixed = { .data = _arr_mixed, .length = 4 };
#line 18 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("Mixed: ", _ks_json_stringify(ks_arr(&mixed))))); printf("\n");
#line 21 "examples/arrays.ks"
    static ks_val_t _arr_names[] = {(ks_val_t){.tag=KS_T_STR,.as.s=(char*)"Alice"}, (ks_val_t){.tag=KS_T_STR,.as.s=(char*)"Bob"}, (ks_val_t){.tag=KS_T_STR,.as.s=(char*)"Charlie"}};
    ks_array names = { .data = _arr_names, .length = 3 };
#line 22 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("Names: ", _ks_json_stringify(ks_arr(&names))))); printf("\n");
#line 25 "examples/arrays.ks"
    ks_val_print(ks_str("\n=== Array Properties ===")); printf("\n");
#line 26 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("Length: ", ks_val_to_str(ks_int(numbers.length))))); printf("\n");
#line 27 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("First element: ", ks_val_to_str(ks_array_get(numbers, KS_INT(0LL)))))); printf("\n");
#line 28 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("Last element: ", ks_val_to_str(ks_array_get(numbers, ks_v_sub(ks_int(numbers.length), KS_INT(1LL))))))); printf("\n");
#line 31 "examples/arrays.ks"
    ks_val_print(ks_str("\n=== Array Methods ===")); printf("\n");
#line 34 "examples/arrays.ks"
    static ks_val_t _arr_arr[] = {(ks_val_t){.tag=KS_T_INT,.as.i=1LL}, (ks_val_t){.tag=KS_T_INT,.as.i=2LL}};
    ks_array arr = { .data = _arr_arr, .length = 2 };
#line 35 "examples/arrays.ks"
    (_ks_array_append(&arr, KS_INT(3LL)), 0);
#line 36 "examples/arrays.ks"
    (_ks_array_append(&arr, KS_INT(4LL)), 0);
#line 37 "examples/arrays.ks"
    (_ks_array_append(&arr, KS_INT(5LL)), 0);
#line 38 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("After push(3,4,5): ", _ks_json_stringify(ks_arr(&arr))))); printf("\n");
#line 41 "examples/arrays.ks"
    ks_val_t popped = _ks_array_pop(&arr);
#line 42 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("Popped: ", ks_val_to_str(popped)))); printf("\n");
#line 43 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("After pop: ", _ks_json_stringify(ks_arr(&arr))))); printf("\n");
#line 46 "examples/arrays.ks"
    (_ks_array_unshift(&arr, KS_INT(0LL)), 0);
#line 47 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("After unshift(0): ", _ks_json_stringify(ks_arr(&arr))))); printf("\n");
#line 50 "examples/arrays.ks"
    ks_val_t shifted = _ks_array_shift(&arr);
#line 51 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("Shifted: ", ks_val_to_str(shifted)))); printf("\n");
#line 52 "examples/arrays.ks"
    ks_val_print(ks_str(_ks_concat("After shift: ", _ks_json_stringify(ks_arr(&arr))))); printf("\n");
#line 55 "examples/arrays.ks"
    ks_val_print(ks_str("\n=== Array Iteration ===")); printf("\n");
    for (long long i = 0; i < numbers.length; i++) {
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("  [", ks_val_to_str(ks_int(i))), "] = "), ks_val_to_str(ks_array_get(numbers, ks_int(i)))))); printf("\n");
}
#line 63 "examples/arrays.ks"
ks_val_print(ks_str("\n=== Array Slicing ===")); printf("\n");
#line 64 "examples/arrays.ks"
static ks_val_t _arr_slice[] = {(ks_val_t){.tag=KS_T_INT,.as.i=1LL}, (ks_val_t){.tag=KS_T_INT,.as.i=2LL}, (ks_val_t){.tag=KS_T_INT,.as.i=3LL}, (ks_val_t){.tag=KS_T_INT,.as.i=4LL}, (ks_val_t){.tag=KS_T_INT,.as.i=5LL}};
ks_array slice = { .data = _arr_slice, .length = 5 };
#line 65 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Original: ", _ks_json_stringify(ks_arr(&slice))))); printf("\n");
#line 68 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Element at index 2: ", ks_val_to_str(ks_array_get(slice, KS_INT(2LL)))))); printf("\n");
#line 71 "examples/arrays.ks"
ks_val_print(ks_str("\n=== Array Searching ===")); printf("\n");
#line 72 "examples/arrays.ks"
static ks_val_t _arr_fruits[] = {(ks_val_t){.tag=KS_T_STR,.as.s=(char*)"apple"}, (ks_val_t){.tag=KS_T_STR,.as.s=(char*)"banana"}, (ks_val_t){.tag=KS_T_STR,.as.s=(char*)"cherry"}, (ks_val_t){.tag=KS_T_STR,.as.s=(char*)"banana"}};
ks_array fruits = { .data = _arr_fruits, .length = 4 };
#line 75 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Contains apple: ", ks_val_to_str(ks_bool(_ks_array_contains(fruits, ks_str("apple"))))))); printf("\n");
#line 76 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Contains mango: ", ks_val_to_str(ks_bool(_ks_array_contains(fruits, ks_str("mango"))))))); printf("\n");
#line 80 "examples/arrays.ks"
ks_val_t found = KS_BOOL(0);
for (long long i = 0; i < fruits.length; i++) {
if (ks_v_bool(ks_bool(ks_v_cmp(ks_array_get(fruits, ks_int(i)), ks_str(("banana"))) == 0))) {
    ks_val_print(ks_str(_ks_concat("Found banana at index: ", ks_val_to_str(ks_int(i))))); printf("\n");
    found = KS_BOOL(1);
}
}
#line 89 "examples/arrays.ks"
ks_val_print(ks_str("\n=== Array Modification ===")); printf("\n");
#line 90 "examples/arrays.ks"
static ks_val_t _arr_nums[] = {(ks_val_t){.tag=KS_T_INT,.as.i=1LL}, (ks_val_t){.tag=KS_T_INT,.as.i=2LL}, (ks_val_t){.tag=KS_T_INT,.as.i=3LL}, (ks_val_t){.tag=KS_T_INT,.as.i=4LL}, (ks_val_t){.tag=KS_T_INT,.as.i=5LL}};
ks_array nums = { .data = _arr_nums, .length = 5 };
#line 93 "examples/arrays.ks"
ks_array reversed = { .data = NULL, .length = 0 };
for (long long i = 0; i < nums.length; i++) {
(_ks_array_append(&reversed, ks_array_get(nums, ks_v_sub(ks_v_sub(ks_int(nums.length), KS_INT(1LL)), ks_int(i)))), 0);
}
#line 97 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Reversed: ", _ks_json_stringify(ks_arr(&reversed))))); printf("\n");
#line 100 "examples/arrays.ks"
ks_val_print(ks_str("\n=== Array with Structs ===")); printf("\n");
#line 115 "examples/arrays.ks"
ks_val_t _arr_points[3];
_arr_points[0] = ks_obj((void*)__new_Point__(1LL, 2LL));
_arr_points[1] = ks_obj((void*)__new_Point__(3LL, 4LL));
_arr_points[2] = ks_obj((void*)__new_Point__(5LL, 6LL));
ks_array points = { .data = _arr_points, .length = 3 };
for (long long i = 0; i < points.length; i++) {
ks_val_print(ks_str(_ks_concat("  ", __method_Point_to_string__((Point_t*)(ks_array_get(points, ks_int(i))).as.p)))); printf("\n");
}
#line 121 "examples/arrays.ks"
ks_val_print(ks_str("\n=== Array Copy ===")); printf("\n");
#line 122 "examples/arrays.ks"
static ks_val_t _arr_original[] = {(ks_val_t){.tag=KS_T_INT,.as.i=1LL}, (ks_val_t){.tag=KS_T_INT,.as.i=2LL}, (ks_val_t){.tag=KS_T_INT,.as.i=3LL}};
ks_array original = { .data = _arr_original, .length = 3 };
#line 123 "examples/arrays.ks"
#define copy original
#line 124 "examples/arrays.ks"
(_ks_array_append(&copy, KS_INT(4LL)), 0);
#line 125 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Original: ", _ks_json_stringify(ks_arr(&original))))); printf("\n");
#line 126 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Copy (same reference): ", _ks_json_stringify(ks_arr(&copy))))); printf("\n");
#line 129 "examples/arrays.ks"
ks_val_print(ks_str("\n=== Array Filtering (manual) ===")); printf("\n");
#line 130 "examples/arrays.ks"
static ks_val_t _arr_all_numbers[] = {(ks_val_t){.tag=KS_T_INT,.as.i=1LL}, (ks_val_t){.tag=KS_T_INT,.as.i=2LL}, (ks_val_t){.tag=KS_T_INT,.as.i=3LL}, (ks_val_t){.tag=KS_T_INT,.as.i=4LL}, (ks_val_t){.tag=KS_T_INT,.as.i=5LL}, (ks_val_t){.tag=KS_T_INT,.as.i=6LL}, (ks_val_t){.tag=KS_T_INT,.as.i=7LL}, (ks_val_t){.tag=KS_T_INT,.as.i=8LL}, (ks_val_t){.tag=KS_T_INT,.as.i=9LL}, (ks_val_t){.tag=KS_T_INT,.as.i=10LL}};
ks_array all_numbers = { .data = _arr_all_numbers, .length = 10 };
#line 131 "examples/arrays.ks"
ks_array evens = { .data = NULL, .length = 0 };
#line 132 "examples/arrays.ks"
ks_array odds = { .data = NULL, .length = 0 };
for (long long i = 0; i < all_numbers.length; i++) {
if (ks_v_bool(ks_bool(ks_v_cmp(ks_v_mod(ks_array_get(all_numbers, ks_int(i)), KS_INT(2LL)), KS_INT(0LL)) == 0))) {
(_ks_array_append(&evens, ks_array_get(all_numbers, ks_int(i))), 0);
} else {
(_ks_array_append(&odds, ks_array_get(all_numbers, ks_int(i))), 0);
}
}
#line 141 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Evens: ", _ks_json_stringify(ks_arr(&evens))))); printf("\n");
#line 142 "examples/arrays.ks"
ks_val_print(ks_str(_ks_concat("Odds: ", _ks_json_stringify(ks_arr(&odds))))); printf("\n");
#line 145 "examples/arrays.ks"
ks_val_print(ks_str("\n=== All Tests Complete ===")); printf("\n");
return 0;
}