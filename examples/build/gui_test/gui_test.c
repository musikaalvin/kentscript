...
void _ks_init_globals(void) {
    window = _ks_create_window(gui, "Simple Test", KS_INT(400LL), KS_INT(300LL));
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    _ks_init_globals();
#line 6 "examples/gui_test.ks"
    _ks_configure(gui, window);
#line 9 "examples/gui_test.ks"
    long long btn1 = _ks_create_button(gui, window, "Click Me", &_ks_lambda_unknown);
#line 12 "examples/gui_test.ks"
    _ks_pack(gui, btn1);
#line 14 "examples/gui_test.ks"
    long long btn2 = _ks_create_button(gui, window, "Another Button", &_ks_lambda_unknown);
#line 17 "examples/gui_test.ks"
    _ks_pack(gui, btn2);
#line 19 "examples/gui_test.ks"
    long long btn3 = _ks_create_button(gui, window, "Third Button", &_ks_lambda_unknown);
#line 22 "examples/gui_test.ks"
    _ks_pack(gui, btn3);
#line 25 "examples/gui_test.ks"
    long long menubar = _ks_create_menu(gui, window);
#line 26 "examples/gui_test.ks"
    _ks_config(window);
#line 28 "examples/gui_test.ks"
    long long file_menu = _ks_create_menu(gui, menubar);
#line 29 "examples/gui_test.ks"
    _ks_menu_add_cascade(gui, menubar, "File", file_menu);
#line 30 "examples/gui_test.ks"
    _ks_menu_add_command(gui, file_menu, "About", &_ks_lambda_unknown);
#line 33 "examples/gui_test.ks"
    _ks_menu_add_separator(gui, file_menu);
#line 34 "examples/gui_test.ks"
    _ks_menu_add_command(gui, file_menu, "Exit", &_ks_lambda_unknown);
#line 38 "examples/gui_test.ks"
    long long help_menu = _ks_create_menu(gui, menubar);
#line 39 "examples/gui_test.ks"
    _ks_menu_add_cascade(gui, menubar, "Help", help_menu);
#line 40 "examples/gui_test.ks"
    _ks_menu_add_command(gui, help_menu, "Info", &_ks_lambda_unknown);
#line 43 "examples/gui_test.ks"
    _ks_menu_add_command(gui, help_menu, "Warning", &_ks_lambda_unknown);
#line 46 "examples/gui_test.ks"
    _ks_menu_add_command(gui, help_menu, "Error", &_ks_lambda_unknown);
#line 50 "examples/gui_test.ks"
