...
#line 5 "examples/opening_reading_files.ks"
    (ks_os_write_file("/tmp/msg.txt", "gotcha!"), 0);
#line 8 "examples/opening_reading_files.ks"
    char* content = ks_os_read_file("/tmp/msg.txt");
#line 9 "examples/opening_reading_files.ks"
    ks_val_print(ks_str(content)); printf("\n");
    if (ks_v_bool(ks_int(ks_os_exists("/tmp/msg.txt")))) {
        ks_val_print(ks_str("File exists")); printf("\n");
        ks_val_print(ks_str(_ks_concat("Size: ", _ks_str_int(system_file_stat("/tmp/msg.txt"))))); printf("\n");
    }
#line 23 "examples/opening_reading_files.ks"
    long long file = system_open("/tmp/msg.txt", O_WRONLY|O_CREAT|O_TRUNC, 0644);
#line 24 "examples/opening_reading_files.ks"
    (system_write(file, "gotcha!", (long long)strlen("gotcha!")), 0);
#line 25 "examples/opening_reading_files.ks"
    (close(file), 0);
#line 28 "examples/opening_reading_files.ks"
    long long file2 = system_open("/tmp/msg.txt", 0, 0644);
#line 29 "examples/opening_reading_files.ks"
    content = system_read(file2, 1048576);
#line 30 "examples/opening_reading_files.ks"
    ks_val_print(ks_str(content)); printf("\n");
#line 31 "examples/opening_reading_files.ks"
    (close(file2), 0);
#line 39 "examples/opening_reading_files.ks"
    file = system_open("/tmp/msg.txt", O_WRONLY|O_CREAT|O_TRUNC, 0644);
#line 40 "examples/opening_reading_files.ks"
    (system_write(file, "gotcha!", (long long)strlen("gotcha!")), 0);
#line 41 "examples/opening_reading_files.ks"
    (close(file), 0);
#line 44 "examples/opening_reading_files.ks"
    file2 = system_open("/tmp/msg.txt", 0, 0644);
#line 45 "examples/opening_reading_files.ks"
    content = system_read(file2, 1048576);
#line 46 "examples/opening_reading_files.ks"
    ks_val_print(ks_str(content)); printf("\n");
#line 47 "examples/opening_reading_files.ks"
    (close(file2), 0);
#line 55 "examples/opening_reading_files.ks"
    (ks_os_write_file("/tmp/msg.txt", "gotcha!"), 0);
#line 58 "examples/opening_reading_files.ks"
    char* text = ks_os_read_file("/tmp/msg.txt");
#line 59 "examples/opening_reading_files.ks"
    ks_val_print(ks_str(text)); printf("\n");
#line 62 "examples/opening_reading_files.ks"
    (ks_os_append_file("/tmp/msg.txt", "\nAnother line!"), 0);
    if (ks_v_bool(ks_int(ks_os_exists("/tmp/msg.txt")))) {
        ks_val_print(ks_str("File exists")); printf("\n");
    }
#line 70 "examples/opening_reading_files.ks"
    (ks_os_remove("/tmp/msg.txt"), 0);
#line 71 "examples/opening_reading_files.ks"
    ks_val_print(ks_str("File deleted")); printf("\n");
    return 0;
}