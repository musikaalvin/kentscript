...
ks_val_t n = {.tag = KS_T_INT, .as.i = 16LL};
long long a;
long long b;
long long c;

void _ks_init_globals(void) {
    a = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
    b = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
    c = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
}
...
#line 15 "examples/regression_simd_gpu.ks"
ks_simd_f32_bin_add((float*)(a), (float*)(b), (float*)(c), (_ks_as_i(n)));
#line 16 "examples/regression_simd_gpu.ks"
ks_val_t addok = KS_INT(1LL);
for (long long i = 0; i < (n).as.i; i++) {
if (ks_v_bool(ks_bool(ks_v_cmp(ks_flt(((float*)(c))[(i)]), KS_FLT(5.0)) != 0))) {
    addok = KS_INT(0LL);
}
}
#line 20 "examples/regression_simd_gpu.ks"
char* addres = "FAIL";
if (ks_v_bool(ks_bool(ks_v_cmp(addok, KS_INT(1LL)) == 0))) {
addres = "PASS";
}
#line 22 "examples/regression_simd_gpu.ks"
ks_val_print(ks_str(_ks_concat("simd add   : ", addres))); printf("\n");
#line 25 "examples/regression_simd_gpu.ks"
ks_val_t s = ks_flt(ks_simd_sum_f32((float*)(c), (_ks_as_i(n))));
#line 26 "examples/regression_simd_gpu.ks"
char* sumres = "FAIL";
if (ks_v_bool(ks_bool(ks_v_cmp(s, KS_FLT(80.0)) == 0))) {
sumres = "PASS";
}
#line 28 "examples/regression_simd_gpu.ks"
ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("simd sum   : ", ks_val_to_str(s)), " "), sumres))); printf("\n");
#line 31 "examples/regression_simd_gpu.ks"
ks_val_t d = ks_flt(ks_simd_dot_f32((float*)(a), (float*)(b), (_ks_as_i(n))));
#line 32 "examples/regression_simd_gpu.ks"
char* dotres = "FAIL";
if (ks_v_bool(ks_bool(ks_v_cmp(d, KS_FLT(96.0)) == 0))) {
dotres = "PASS";
}
#line 34 "examples/regression_simd_gpu.ks"
ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("simd dot   : ", ks_val_to_str(d)), " "), dotres))); printf("\n");
#line 37 "examples/regression_simd_gpu.ks"
long long g = ((long long)ks_gpu_supported());
#line 38 "examples/regression_simd_gpu.ks"
ks_val_print(ks_str(_ks_concat("gpu avail  : ", _ks_str_int(g)))); printf("\n");
#line 39 "examples/regression_simd_gpu.ks"
ks_gpu_f32_binop("+", (float*)(a), (float*)(b), (float*)(c), (_ks_as_i(n)));
#line 40 "examples/regression_simd_gpu.ks"
ks_val_t gpuc0 = ks_flt(((float*)(c))[(0LL)]);
#line 41 "examples/regression_simd_gpu.ks"
char* gpuok = "FAIL";
if (ks_v_bool(ks_bool(ks_v_cmp(gpuc0, KS_FLT(5.0)) == 0))) {
gpuok = "PASS";
}
#line 43 "examples/regression_simd_gpu.ks"
ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("gpu add c0 : ", ks_val_to_str(gpuc0)), " "), gpuok))); printf("\n");
#line 45 "examples/regression_simd_gpu.ks"
_ks_simd_free((void*)(a));
#line 46 "examples/regression_simd_gpu.ks"
_ks_simd_free((void*)(b));
#line 47 "examples/regression_simd_gpu.ks"
_ks_simd_free((void*)(c));
#line 48 "examples/regression_simd_gpu.ks"
ks_val_print(ks_str("=== regression done ===")); printf("\n");
return 0;
}