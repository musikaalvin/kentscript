...
#line 4 "examples/low_level_demo.ks"
    ks_val_print(ks_str("=== KentScript Low-Level Features Demo ===")); printf("\n");
#line 5 "examples/low_level_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 10 "examples/low_level_demo.ks"
    ks_val_print(ks_str("1. Type Aliases:")); printf("\n");
#line 11 "examples/low_level_demo.ks"
    ks_val_t count = KS_INT(42LL);
#line 12 "examples/low_level_demo.ks"
    long long size = (KS_INT(1024LL));
#line 13 "examples/low_level_demo.ks"
    ks_val_t ratio = KS_FLT(3.14159);
#line 14 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat("  int: ", ks_val_to_str(count)))); printf("\n");
#line 15 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat("  uint: ", _ks_str_int(size)))); printf("\n");
#line 16 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat("  float: ", ks_val_to_str(ratio)))); printf("\n");
#line 17 "examples/low_level_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 22 "examples/low_level_demo.ks"
    ks_val_print(ks_str("2. F-String Interpolation:")); printf("\n");
#line 23 "examples/low_level_demo.ks"
    char* lang = "KentScript";
#line 24 "examples/low_level_demo.ks"
    ks_val_t year = KS_INT(2024LL);
#line 25 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("  ", lang), " was created in "), ks_val_to_str(year)))); printf("\n");
#line 26 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat("  Expression: 2 + 2 = ", ks_val_to_str(ks_v_add(KS_INT(2LL), KS_INT(2LL)))))); printf("\n");
#line 27 "examples/low_level_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 32 "examples/low_level_demo.ks"
    ks_val_print(ks_str("3. Tuple Destructuring:")); printf("\n");
#line 33 "examples/low_level_demo.ks"
    ks_array _tuple_tmp_0 = {NULL, 0};
    _ks_array_append(&_tuple_tmp_0, (long long)(KS_INT(100LL)));
    _ks_array_append(&_tuple_tmp_0, (long long)(KS_INT(200LL)));
    _ks_array_append(&_tuple_tmp_0, (long long)(KS_INT(300LL)));
    ks_val_t _destr_1 = _tuple_tmp_0;
    ks_val_t x = ks_val_array_get(_destr_1, ks_int((long long)0));
    ks_val_t y = ks_val_array_get(_destr_1, ks_int((long long)1));
    ks_val_t z = ks_val_array_get(_destr_1, ks_int((long long)2));
#line 34 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("  x=", ks_val_to_str(x)), ", y="), ks_val_to_str(y)), ", z="), ks_val_to_str(z)))); printf("\n");
#line 35 "examples/low_level_demo.ks"
    ks_array _tuple_tmp_2 = {NULL, 0};
    _ks_array_append(&_tuple_tmp_2, (long long)(KS_INT(10LL)));
    _ks_array_append(&_tuple_tmp_2, (long long)(KS_INT(20LL)));
    ks_val_t _destr_3 = _tuple_tmp_2;
    ks_val_t a = ks_val_array_get(_destr_3, ks_int((long long)0));
    ks_val_t b = ks_val_array_get(_destr_3, ks_int((long long)1));
#line 36 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("  a=", ks_val_to_str(a)), ", b="), ks_val_to_str(b)))); printf("\n");
#line 37 "examples/low_level_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 42 "examples/low_level_demo.ks"
    ks_val_print(ks_str("4. Arrays:")); printf("\n");
#line 43 "examples/low_level_demo.ks"
...
#line 44 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat("  Array: ", _ks_str_array(numbers.data, numbers.length)))); printf("\n");
#line 45 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat("  First element: ", ks_val_to_str(ks_array_get(numbers, KS_INT(0LL)))))); printf("\n");
#line 46 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat("  Last element: ", ks_val_to_str(ks_array_get(numbers, KS_INT(4LL)))))); printf("\n");
#line 47 "examples/low_level_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 52 "examples/low_level_demo.ks"
    ks_val_print(ks_str("5. Low-Level Operations (unsafe block):")); printf("\n");
    /* unsafe block */
    {
        ks_val_print(ks_str("  a) Address-of operator (&):")); printf("\n");
        ks_val_t value = KS_INT(12345LL);
        void* addr = ((void*)(&value));
        ks_val_print(ks_str(_ks_concat("     value = ", ks_val_to_str(value)))); printf("\n");
        ks_val_print(ks_str(_ks_concat("     &value = ", _ks_str_hex((long long)(uintptr_t)addr)))); printf("\n");
        ks_val_print(ks_str("")); printf("\n");
        ks_val_print(ks_str("  b) Type Casting (as):")); printf("\n");
        ks_val_t pi = KS_FLT(3.14159);
        ks_val_t pi_int = ((long long)pi);
        ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("     ", ks_val_to_str(pi)), " as int = "), ks_val_to_str(pi_int)))); printf("\n");
        ks_val_t hex_val = KS_INT(255LL);
        void* hex_ptr = ((void*)(uintptr_t)(_ks_as_i(hex_val)));
        ks_val_print(ks_str(_ks_concat("     0xFF as ptr = ", _ks_str_hex((long long)(uintptr_t)hex_ptr)))); printf("\n");
        ks_val_print(ks_str("")); printf("\n");
        ks_val_print(ks_str("  c) Pointer Values:")); printf("\n");
        void* base = ((void*)(uintptr_t)(_ks_as_i(KS_INT(4096LL))));
        void* offset = ((void*)(uintptr_t)(_ks_as_i(KS_INT(256LL))));
        ks_val_print(ks_str(_ks_concat("     Base address: ", _ks_str_hex((long long)(uintptr_t)base)))); printf("\n");
        ks_val_print(ks_str(_ks_concat("     Offset: ", _ks_str_hex((long long)(uintptr_t)offset)))); printf("\n");
        ks_val_print(ks_str("")); printf("\n");
        ks_val_print(ks_str("  d) Inline Assembly:")); printf("\n");
        __asm__("nop");
        ks_val_print(ks_str("     Executed: asm(\"nop\")")); printf("\n");
        __asm__("mov eax, 0");
        ks_val_print(ks_str("     Executed: asm(\"mov eax, 0\")")); printf("\n");
    }
#line 90 "examples/low_level_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 95 "examples/low_level_demo.ks"
    ks_val_print(ks_str("6. Combined Example:")); printf("\n");
#line 96 "examples/low_level_demo.ks"
    ks_val_t data = KS_INT(3735928559LL);
#line 97 "examples/low_level_demo.ks"
    ks_val_print(ks_str(_ks_concat("  Original value: ", ks_val_to_str(data)))); printf("\n");
    /* unsafe block */
    {
        void* data_addr = ((void*)(&data));
        ks_val_print(ks_str(_ks_concat("  Address: ", _ks_str_hex((long long)(uintptr_t)data_addr)))); printf("\n");
        ks_val_t as_float = ((double)data);
        ks_val_print(ks_str(_ks_concat("  As float: ", ks_val_to_str(as_float)))); printf("\n");
        ks_array _tuple_tmp_4 = {NULL, 0};
        _ks_array_append(&_tuple_tmp_4, (long long)(data));
        _ks_array_append(&_tuple_tmp_4, (long long)(data));
        ks_val_t _destr_5 = _tuple_tmp_4;
        ks_val_t high = ks_val_array_get(_destr_5, ks_int((long long)0));
        ks_val_t low = ks_val_array_get(_destr_5, ks_int((long long)1));
        ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("  Split: high=", ks_val_to_str(high)), ", low="), ks_val_to_str(low)))); printf("\n");
    }
#line 110 "examples/low_level_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 111 "examples/low_level_demo.ks"
    ks_val_print(ks_str("=== All Features Working! ===")); printf("\n");
    return 0;
}