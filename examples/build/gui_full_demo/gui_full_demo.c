...
void _ks_init_globals(void) {
    tk = 0  /* gui.tk */;
    ttk = 0  /* gui.ttk */;
    win = _ks_create_window(gui, "KentScript GUI Demo", KS_INT(500LL), KS_INT(400LL));
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    _ks_init_globals();
#line 11 "examples/gui_full_demo.ks"
    _ks_title(gui, win, "KentScript GUI Demo");
#line 14 "examples/gui_full_demo.ks"
    long long main = _ks_create_frame(gui, win);
#line 15 "examples/gui_full_demo.ks"
    _ks_pack(gui, main);
#line 18 "examples/gui_full_demo.ks"
    _ks_pack(_ks_create_label(gui, main, "=== KentScript GUI + Tkinter ==="));
#line 21 "examples/gui_full_demo.ks"
    long long canvas = _ks_Canvas(tk, main);
#line 22 "examples/gui_full_demo.ks"
    _ks_pack(gui, canvas);
#line 23 "examples/gui_full_demo.ks"
    _ks_create_line(0  /* tk.Canvas */, canvas, KS_INT(10LL), KS_INT(10LL), KS_INT(100LL), KS_INT(100LL));
#line 24 "examples/gui_full_demo.ks"
    _ks_create_oval(0  /* tk.Canvas */, canvas, KS_INT(150LL), KS_INT(50LL), KS_INT(250LL), KS_INT(150LL));
#line 25 "examples/gui_full_demo.ks"
    _ks_create_rectangle(0  /* tk.Canvas */, canvas, KS_INT(300LL), KS_INT(50LL), KS_INT(400LL), KS_INT(150LL));
#line 28 "examples/gui_full_demo.ks"
    long long text_var = _ks_StringVar(tk);
#line 29 "examples/gui_full_demo.ks"
    _ks_set(text_var, "Type here...");
#line 31 "examples/gui_full_demo.ks"
    long long entry_frame = _ks_create_frame(gui, main);
#line 32 "examples/gui_full_demo.ks"
    _ks_pack(gui, entry_frame);
#line 33 "examples/gui_full_demo.ks"
    _ks_pack(_ks_create_label(gui, entry_frame, "Entry:"));
#line 34 "examples/gui_full_demo.ks"
    long long entry = _ks_Entry(tk, entry_frame);
#line 35 "examples/gui_full_demo.ks"
    _ks_pack(entry);
#line 38 "examples/gui_full_demo.ks"
    long long counter = _ks_IntVar(tk);
#line 39 "examples/gui_full_demo.ks"
    _ks_set(counter, KS_INT(0LL));
#line 41 "examples/gui_full_demo.ks"
    long long counter_frame = _ks_create_frame(gui, main);
#line 42 "examples/gui_full_demo.ks"
    _ks_pack(gui, counter_frame);
#line 44 "examples/gui_full_demo.ks"
    long long count_label = _ks_create_label(gui, counter_frame);
#line 45 "examples/gui_full_demo.ks"
    _ks_pack(gui, count_label);
#line 47 "examples/gui_full_demo.ks"
    long long inc_btn = _ks_Button(tk, counter_frame);
#line 48 "examples/gui_full_demo.ks"
    _ks_pack(inc_btn);
#line 50 "examples/gui_full_demo.ks"
    long long dec_btn = _ks_Button(tk, counter_frame);
#line 51 "examples/gui_full_demo.ks"
    _ks_pack(dec_btn);
#line 53 "examples/gui_full_demo.ks"
    long long reset_btn = _ks_Button(tk, counter_frame);
#line 54 "examples/gui_full_demo.ks"
    _ks_pack(reset_btn);
#line 57 "examples/gui_full_demo.ks"
    long long list_frame = _ks_create_frame(gui, main);
#line 58 "examples/gui_full_demo.ks"
    _ks_pack(gui, list_frame);
#line 59 "examples/gui_full_demo.ks"
    _ks_pack(_ks_create_label(gui, list_frame, "Fruits:"));
#line 61 "examples/gui_full_demo.ks"
    long long listbox = _ks_Listbox(tk, list_frame);
#line 62 "examples/gui_full_demo.ks"
    _ks_pack(listbox);
    ks_val_t _la_1[] = {"Apple", "Banana", "Orange", "Mango"};
    ks_array _iter_expr_0 = { .data = _la_1, .length = 4 };
    for (long long _idx_fruit = 0; _idx_fruit < _iter_expr_0.length; _idx_fruit++) {
        ks_val_t fruit = ks_array_get(_iter_expr_0, ks_int((long long)(_idx_fruit)));
        _ks_insert(listbox, "end", fruit);
    }
#line 69 "examples/gui_full_demo.ks"
    long long btn_frame = _ks_create_frame(gui, main);
#line 70 "examples/gui_full_demo.ks"
    _ks_pack(gui, btn_frame);
#line 72 "examples/gui_full_demo.ks"
    long long msg_btn = _ks_Button(tk, btn_frame);
#line 73 "examples/gui_full_demo.ks"
    _ks_pack(msg_btn);
#line 75 "examples/gui_full_demo.ks"
    long long color_btn = _ks_Button(tk, btn_frame);
#line 76 "examples/gui_full_demo.ks"
    _ks_pack(color_btn);
#line 78 "examples/gui_full_demo.ks"
    long long exit_btn = _ks_Button(tk, btn_frame);
#line 79 "examples/gui_full_demo.ks"
    _ks_pack(exit_btn);
#line 81 "examples/gui_full_demo.ks"
    _ks_mainloop(gui, win);
    return 0;
}