...
ks_val_t read_proc(ks_val_t path);
ks_val_t parse_val(ks_val_t line);

#line 12 "examples/sysinfo_lowlevel.ks"
ks_val_t read_proc(ks_val_t path) {
    long long fd = system_open(ks_val_to_str(path), O_RDONLY, 0644);
    char* data = system_read(fd, 8192LL);
    system_close(fd);
    return ks_str(data);
    return ks_none();
}

#line 20 "examples/sysinfo_lowlevel.ks"
ks_val_t parse_val(ks_val_t line) {
    ks_val_t i = KS_INT(0LL);
    ks_val_t len_line = ks_int((long long)(_ks_len(line)));
    while (ks_v_bool(ks_bool(ks_v_cmp(i, ks_v_sub(len_line, KS_INT(1LL))) < 0))) {
        if (__builtin_expect((ks_v_bool(ks_bool(ks_v_bool(ks_bool(ks_v_cmp(ks_val_array_get(line, i), ks_str((":"))) == 0)) && ks_v_bool(ks_bool(ks_v_cmp(ks_val_array_get(line, ks_v_add(i, KS_INT(1LL))), ks_str((" "))) == 0))))), 0)) {
            ks_array _slice_tmp_0 = _ks_slice(line, ks_v_add(i, KS_INT(2LL)), ks_int(line.length), KS_INT(1LL));
            return _slice_tmp_0;
        }
        i = ks_v_add(i, KS_INT(1LL));
    }
    return line;
    return ks_none();
}
...
#line 8 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("=== System Info (Low-Level) ===\n")); printf("\n");
#line 33 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("--- Process Identity (syscall wrappers) ---")); printf("\n");
#line 34 "examples/sysinfo_lowlevel.ks"
    long long pid = system_os_getpid();
#line 35 "examples/sysinfo_lowlevel.ks"
    long long ppid = system_os_getppid();
#line 36 "examples/sysinfo_lowlevel.ks"
    long long uid = system_os_getuid();
#line 37 "examples/sysinfo_lowlevel.ks"
    long long gid = system_os_getgid();
#line 38 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("PID:  ", _ks_str_int(pid)))); printf("\n");
#line 39 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("PPID: ", _ks_str_int(ppid)))); printf("\n");
#line 40 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("UID:  ", _ks_str_int(uid)))); printf("\n");
#line 41 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("GID:  ", _ks_str_int(gid)))); printf("\n");
#line 42 "examples/sysinfo_lowlevel.ks"
    char* cwd = system_file_getcwd();
#line 43 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("CWD:  ", cwd))); printf("\n");
#line 46 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Kernel ---")); printf("\n");
#line 47 "examples/sysinfo_lowlevel.ks"
    ks_val_t version_raw = read_proc(ks_str(("/proc/version")));
#line 48 "examples/sysinfo_lowlevel.ks"
    ks_array _slice_tmp_1 = _ks_slice(version_raw, KS_INT(0LL), ks_int(_ks_find_idx(ks_val_to_str(version_raw), "\n")), KS_INT(1LL));
    ks_val_t version_line = _slice_tmp_1;
#line 49 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("Version: ", ks_val_to_str(version_line)))); printf("\n");
#line 52 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Uptime (from /proc/uptime) ---")); printf("\n");
#line 53 "examples/sysinfo_lowlevel.ks"
    ks_val_t uptime_raw = read_proc(ks_str(("/proc/uptime")));
#line 54 "examples/sysinfo_lowlevel.ks"
    ks_array _slice_tmp_2 = _ks_slice(uptime_raw, KS_INT(0LL), ks_int(_ks_find_idx(ks_val_to_str(uptime_raw), " ")), KS_INT(1LL));
    ks_val_t uptime_secs = ks_flt(atof(_slice_tmp_2));
#line 55 "examples/sysinfo_lowlevel.ks"
    ks_val_t up_days = ks_v_div(uptime_secs, KS_INT(86400LL));
#line 56 "examples/sysinfo_lowlevel.ks"
    ks_val_t up_hrs = ks_v_div(ks_v_mod(uptime_secs, KS_INT(86400LL)), KS_INT(3600LL));
#line 57 "examples/sysinfo_lowlevel.ks"
    ks_val_t up_mins = ks_v_div(ks_v_mod(uptime_secs, KS_INT(3600LL)), KS_INT(60LL));
#line 58 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Uptime: ", ks_val_to_str(up_days)), "d "), ks_val_to_str(up_hrs)), "h "), ks_val_to_str(up_mins)), "m  ("), ks_val_to_str(uptime_secs)), "s)"))); printf("\n");
#line 61 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Load Average (from /proc/loadavg) ---")); printf("\n");
#line 62 "examples/sysinfo_lowlevel.ks"
    ks_val_t load_raw = read_proc(ks_str(("/proc/loadavg")));
#line 63 "examples/sysinfo_lowlevel.ks"
    ks_array load_parts = _ks_str_split(ks_val_to_str(load_raw), " ");
#line 64 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("1 min:  ", ks_val_to_str(ks_array_get(load_parts, KS_INT(0LL)))))); printf("\n");
#line 65 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("5 min:  ", ks_val_to_str(ks_array_get(load_parts, KS_INT(1LL)))))); printf("\n");
#line 66 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("15 min: ", ks_val_to_str(ks_array_get(load_parts, KS_INT(2LL)))))); printf("\n");
#line 67 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("Tasks:  ", ks_val_to_str(ks_array_get(load_parts, KS_INT(3LL)))))); printf("\n");
#line 70 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Memory (from /proc/meminfo) ---")); printf("\n");
#line 71 "examples/sysinfo_lowlevel.ks"
    ks_val_t mem_raw = read_proc(ks_str(("/proc/meminfo")));
#line 72 "examples/sysinfo_lowlevel.ks"
    ks_array mem_lines = _ks_str_split(ks_val_to_str(mem_raw), "\n");
#line 73 "examples/sysinfo_lowlevel.ks"
    _ks_dict* mem = _ks_dict_new();
    ks_array _iter__idx_line = mem_lines;
    for (long long _idx_line = 0; _idx_line < _iter__idx_line.length; _idx_line++) {
        ks_val_t line = ks_array_get(_iter__idx_line, ks_int((long long)(_idx_line)));
        if (ks_v_bool(ks_bool(ks_v_cmp(ks_int(_ks_len(line)), KS_INT(0LL)) > 0))) {
            ks_array parts = _ks_str_split(ks_val_to_str(line), ":");
            if (ks_v_bool(ks_bool(ks_v_cmp(ks_int(ks_array_len(parts)), KS_INT(2LL)) >= 0))) {
                char* key = _ks_str_strip(ks_val_to_str(ks_array_get(parts, KS_INT(0LL))));
                ks_val_t val_str = ks_array_get(_ks_str_split(_ks_str_strip(ks_val_to_str(ks_array_get(parts, KS_INT(1LL)))), " "), KS_INT(0LL));
                _ks_dict_set(mem, key, ks_v_i(ks_flt(atof(val_str))), 0);
            }
        }
    }
#line 84 "examples/sysinfo_lowlevel.ks"
    ks_val_t mem_total = ks_v_div(ks_int(_ks_dict_get_simple(mem, "MemTotal")), KS_INT(1024LL));
#line 85 "examples/sysinfo_lowlevel.ks"
    ks_val_t mem_avail = ks_v_div(ks_int(_ks_dict_get_simple(mem, "MemAvailable")), KS_INT(1024LL));
#line 86 "examples/sysinfo_lowlevel.ks"
    ks_val_t mem_free = ks_v_div(ks_int(_ks_dict_get_simple(mem, "MemFree")), KS_INT(1024LL));
#line 87 "examples/sysinfo_lowlevel.ks"
    ks_val_t mem_buffers = ks_v_div(ks_int(_ks_dict_get_simple(mem, "Buffers")), KS_INT(1024LL));
#line 88 "examples/sysinfo_lowlevel.ks"
    ks_val_t mem_cached = ks_v_div(ks_int(_ks_dict_get_simple(mem, "Cached")), KS_INT(1024LL));
#line 89 "examples/sysinfo_lowlevel.ks"
    ks_val_t mem_used = ks_v_sub(mem_total, mem_avail);
#line 90 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Total:     ", ks_val_to_str(mem_total)), " MB"))); printf("\n");
#line 91 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Available: ", ks_val_to_str(mem_avail)), " MB"))); printf("\n");
#line 92 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Used:      ", ks_val_to_str(mem_used)), " MB"))); printf("\n");
#line 93 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Free:      ", ks_val_to_str(mem_free)), " MB"))); printf("\n");
#line 94 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Buffers:   ", ks_val_to_str(mem_buffers)), " MB"))); printf("\n");
#line 95 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Cached:    ", ks_val_to_str(mem_cached)), " MB"))); printf("\n");
#line 96 "examples/sysinfo_lowlevel.ks"
    ks_val_t swap_total = ks_v_div(ks_int(_ks_dict_get_simple(mem, "SwapTotal")), KS_INT(1024LL));
#line 97 "examples/sysinfo_lowlevel.ks"
    ks_val_t swap_free = ks_v_div(ks_int(_ks_dict_get_simple(mem, "SwapFree")), KS_INT(1024LL));
#line 98 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Swap:      ", ks_val_to_str(ks_v_sub(swap_total, swap_free))), " / "), ks_val_to_str(swap_total)), " MB"))); printf("\n");
#line 101 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- CPU (from /proc/cpuinfo) ---")); printf("\n");
#line 102 "examples/sysinfo_lowlevel.ks"
    ks_val_t cpu_raw = read_proc(ks_str(("/proc/cpuinfo")));
#line 103 "examples/sysinfo_lowlevel.ks"
    ks_array cpu_lines = _ks_str_split(ks_val_to_str(cpu_raw), "\n");
#line 104 "examples/sysinfo_lowlevel.ks"
    char* cpu_model = "";
#line 105 "examples/sysinfo_lowlevel.ks"
    ks_val_t cpu_cores = KS_INT(0LL);
#line 106 "examples/sysinfo_lowlevel.ks"
    char* cpu_mhz = "";
    ks_array _iter__idx_line = cpu_lines;
    for (long long _idx_line = 0; _idx_line < _iter__idx_line.length; _idx_line++) {
        ks_val_t line = ks_array_get(_iter__idx_line, ks_int((long long)(_idx_line)));
        if (ks_v_bool((strncmp(line, "model name", strlen("model name")) == 0))) {
            cpu_model = ks_val_to_str(parse_val(line));
        }
        if (ks_v_bool((strncmp(line, "processor", strlen("processor")) == 0))) {
            cpu_cores = ks_v_add(cpu_cores, KS_INT(1LL));
        }
        if (ks_v_bool((strncmp(line, "cpu MHz", strlen("cpu MHz")) == 0))) {
            cpu_mhz = ks_val_to_str(parse_val(line));
        }
    }
#line 118 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("Model:  ", cpu_model))); printf("\n");
#line 119 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("Cores:  ", ks_val_to_str(cpu_cores)))); printf("\n");
#line 120 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("MHz:    ", cpu_mhz))); printf("\n");
#line 123 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Disk (from /proc/diskstats) ---")); printf("\n");
#line 124 "examples/sysinfo_lowlevel.ks"
    ks_val_t disk_raw = read_proc(ks_str(("/proc/diskstats")));
#line 125 "examples/sysinfo_lowlevel.ks"
    ks_array disk_lines = _ks_str_split(ks_val_to_str(disk_raw), "\n");
    ks_array _iter__idx_line = disk_lines;
    for (long long _idx_line = 0; _idx_line < _iter__idx_line.length; _idx_line++) {
        ks_val_t line = ks_array_get(_iter__idx_line, ks_int((long long)(_idx_line)));
        if (ks_v_bool(ks_bool(ks_v_bool(ks_bool(ks_v_bool(_ks_dict_contains(line, "sda")) || ks_v_bool(_ks_dict_contains(line, "vda")))) || ks_v_bool(_ks_dict_contains(line, "nvme0n1"))))) {
            ks_array parts = _ks_str_split(ks_val_to_str(line), " ");
            ks_array filtered = { .data = NULL, .length = 0 };
            ks_array _iter__idx_p = parts;
            for (long long _idx_p = 0; _idx_p < _iter__idx_p.length; _idx_p++) {
                ks_val_t p = ks_array_get(_iter__idx_p, ks_int((long long)(_idx_p)));
                if (ks_v_bool(ks_bool(ks_v_cmp(ks_int(_ks_len(p)), KS_INT(0LL)) > 0))) {
                    (_ks_array_append(&filtered, p), 0);
                }
            }
            if (ks_v_bool(ks_bool(ks_v_cmp(ks_int(ks_array_len(filtered)), KS_INT(14LL)) >= 0))) {
                ks_val_print(ks_str(_ks_concat("  Device: ", ks_val_to_str(ks_array_get(filtered, KS_INT(2LL)))))); printf("\n");
                ks_val_print(ks_str(_ks_concat("    Reads completed:  ", ks_val_to_str(ks_array_get(filtered, KS_INT(3LL)))))); printf("\n");
                ks_val_print(ks_str(_ks_concat("    Writes completed: ", ks_val_to_str(ks_array_get(filtered, KS_INT(7LL)))))); printf("\n");
                ks_val_print(ks_str(_ks_concat("    Sectors read:     ", ks_val_to_str(ks_array_get(filtered, KS_INT(5LL)))))); printf("\n");
                ks_val_print(ks_str(_ks_concat("    Sectors written:  ", ks_val_to_str(ks_array_get(filtered, KS_INT(9LL)))))); printf("\n");
            }
        }
    }
#line 147 "examples/sysinfo_lowlevel.ks"
    _ks_dict* disk = system_disk_usage("/");
#line 148 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n  Root / usage:")); printf("\n");
#line 149 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("    Total: ", ks_val_to_str(ks_v_div(ks_int(_ks_dict_get_simple(disk, "total")), KS_INT(1073741824LL)))), " GB"))); printf("\n");
#line 150 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("    Free:  ", ks_val_to_str(ks_v_div(ks_int(_ks_dict_get_simple(disk, "free")), KS_INT(1073741824LL)))), " GB"))); printf("\n");
#line 151 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("    Used:  ", _ks_dict_to_str(disk, "percent")), "%"))); printf("\n");
#line 154 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Network (from /sys/class/net) ---")); printf("\n");
#line 155 "examples/sysinfo_lowlevel.ks"
    _ks_dict* ifaces = system_network_interfaces();
    ks_array _iter_expr_3 = (ks_array)(_ks_keys(ifaces));
    for (long long _idx_name = 0; _idx_name < _iter_expr_3.length; _idx_name++) {
        ks_val_t name = ks_array_get(_iter_expr_3, ks_int((long long)(_idx_name)));
        if (ks_v_bool(ks_bool(ks_v_cmp(name, ks_str(("lo"))) != 0))) {
            char* addrs = _ks_dict_to_str(ifaces, _ks_str_int(name));
            char* mac_path = _ks_concat(_ks_concat("/sys/class/net/", _ks_str_int(name)), "/address");
            char* mac = "unknown";
            long long mac_fd = system_open(mac_path, O_RDONLY, 0644);
            if (ks_v_bool(ks_bool(ks_v_cmp(ks_int(mac_fd), KS_INT(0LL)) >= 0))) {
                mac = _ks_str_strip((char*)(uintptr_t)(system_read(mac_fd, 32LL)));
                system_close(mac_fd);
            }
            char* state_path = _ks_concat(_ks_concat("/sys/class/net/", _ks_str_int(name)), "/operstate");
            char* state = "?";
            long long s_fd = system_open(state_path, O_RDONLY, 0644);
            if (ks_v_bool(ks_bool(ks_v_cmp(ks_int(s_fd), KS_INT(0LL)) >= 0))) {
                state = _ks_str_strip((char*)(uintptr_t)(system_read(s_fd, 16LL)));
                system_close(s_fd);
            }
            ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("  ", _ks_str_int(name)), "  ["), state), "]  mac="), mac))); printf("\n");
            for (long long _idx_a = 0; addrs[_idx_a] != '\0'; _idx_a++) {
                char _cstr__idx_a[2] = {0};
                _cstr__idx_a[0] = addrs[_idx_a];
                char* a = _cstr__idx_a;
                ks_val_print(ks_str(_ks_concat("    addr: ", a))); printf("\n");
            }
        }
    }
#line 183 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- OS Release (from /etc/os-release) ---")); printf("\n");
#line 184 "examples/sysinfo_lowlevel.ks"
    ks_val_t osrel_raw = read_proc(ks_str(("/etc/os-release")));
#line 185 "examples/sysinfo_lowlevel.ks"
    ks_array osrel_lines = _ks_str_split(ks_val_to_str(osrel_raw), "\n");
    ks_array _iter__idx_line = osrel_lines;
    for (long long _idx_line = 0; _idx_line < _iter__idx_line.length; _idx_line++) {
        ks_val_t line = ks_array_get(_iter__idx_line, ks_int((long long)(_idx_line)));
        if (ks_v_bool(ks_bool(ks_v_bool(ks_bool(ks_v_bool((strncmp(line, "PRETTY_NAME", strlen("PRETTY_NAME")) == 0)) || ks_v_bool((strncmp(line, "NAME=", strlen("NAME=")) == 0)))) || ks_v_bool((strncmp(line, "VERSION=", strlen("VERSION=")) == 0))))) {
            ks_val_print(ks_str(_ks_concat("  ", ks_val_to_str(parse_val(line))))); printf("\n");
        }
    }
#line 193 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Hostname (from /proc/sys/kernel/hostname) ---")); printf("\n");
#line 194 "examples/sysinfo_lowlevel.ks"
    ks_val_t hostname_raw = read_proc(ks_str(("/proc/sys/kernel/hostname")));
#line 195 "examples/sysinfo_lowlevel.ks"
    char* hostname = _ks_str_strip(ks_val_to_str(hostname_raw));
#line 196 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("Hostname: ", hostname))); printf("\n");
#line 199 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Open File Descriptors (from /proc/self/fd) ---")); printf("\n");
#line 200 "examples/sysinfo_lowlevel.ks"
    ks_val_t fd_count = KS_INT(0LL);
#line 201 "examples/sysinfo_lowlevel.ks"
    long long fd_entries = (ks_os_listdir("/proc/self/fd"), 0);
    fd_count = ks_int((long long)(_ks_len(fd_entries)));
#line 203 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("Open FDs: ", ks_val_to_str(fd_count)))); printf("\n");
#line 206 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Unsafe Allocator Stats ---")); printf("\n");
    /* unsafe block */
    {
        ks_val_t stats = memory_stats();
        ks_val_print(ks_str(_ks_concat("Allocations: ", ks_val_to_str(stats)))); printf("\n");
    }
#line 213 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str("\n--- Report ---")); printf("\n");
#line 214 "examples/sysinfo_lowlevel.ks"
    char* timestamp = system_time_strftime("%Y-%m-%d %H:%M:%S");
#line 215 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("Generated: ", timestamp))); printf("\n");
#line 217 "examples/sysinfo_lowlevel.ks"
    char* report = "/tmp/sysinfo_lowlevel_report.txt";
#line 218 "examples/sysinfo_lowlevel.ks"
    char* report_content = "Low-Level System Information Report\n";
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat("Generated: ", timestamp), "\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat("Hostname:  ", hostname), "\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat("PID:       ", _ks_str_int(pid)), "\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat("PPID:      ", _ks_str_int(ppid)), "\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat("UID:       ", _ks_str_int(uid)), "\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat("GID:       ", _ks_str_int(gid)), "\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat("CWD:       ", cwd), "\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat("Kernel:    ", ks_val_to_str(version_line)), "\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("CPU:       ", cpu_model), " x"), ks_val_to_str(cpu_cores)), " @ "), cpu_mhz), " MHz\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat(_ks_concat(_ks_concat("Memory:    ", ks_val_to_str(mem_used)), " / "), ks_val_to_str(mem_total)), " MB used\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat(_ks_concat(_ks_concat("Swap:      ", ks_val_to_str(ks_v_sub(swap_total, swap_free))), " / "), ks_val_to_str(swap_total)), " MB\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Uptime:    ", ks_val_to_str(up_days)), "d "), ks_val_to_str(up_hrs)), "h "), ks_val_to_str(up_mins)), "m\n"));
    report_content = _ks_concat(report_content, _ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Load:      ", ks_val_to_str(ks_array_get(load_parts, KS_INT(0LL)))), " "), ks_val_to_str(ks_array_get(load_parts, KS_INT(1LL)))), " "), ks_val_to_str(ks_array_get(load_parts, KS_INT(2LL)))), "\n"));
#line 232 "examples/sysinfo_lowlevel.ks"
    system_file_write_text(report, report_content);
#line 233 "examples/sysinfo_lowlevel.ks"
    ks_val_print(ks_str(_ks_concat("Report saved to: ", report))); printf("\n");
    return 0;
}