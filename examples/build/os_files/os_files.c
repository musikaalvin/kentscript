...
#line 4 "examples/os_files.ks"
    (ks_os_write_file("/tmp/test.txt", "Hello KentScript!"), 0);
#line 7 "examples/os_files.ks"
    char* content = ks_os_read_file("/tmp/test.txt");
#line 8 "examples/os_files.ks"
    ks_val_print(ks_str(content)); printf("\n");
    if (ks_v_bool(ks_int(ks_os_exists("/tmp/test.txt")))) {
        ks_val_print(ks_str("File exists!")); printf("\n");
    }
#line 16 "examples/os_files.ks"
    (ks_os_append_file("/tmp/test.txt", " More content!"), 0);
#line 19 "examples/os_files.ks"
    char* content2 = ks_os_read_file("/tmp/test.txt");
#line 20 "examples/os_files.ks"
    ks_val_print(ks_str(content2)); printf("\n");
#line 23 "examples/os_files.ks"
    (ks_os_remove("/tmp/test.txt"), 0);
#line 24 "examples/os_files.ks"
