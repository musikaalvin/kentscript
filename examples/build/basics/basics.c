...
ks_val_t http_status(ks_val_t code);
...
static void __method_Calculator_add__(Calculator_t* self, long long n) {
    __set_Calculator_attr__(self, "value", ks_v_add(ks_int(__get_Calculator_attr_num__(self, "value")), ks_int(n)));
}

static long long __method_Calculator_get_value__(Calculator_t* self) {
    return __get_Calculator_attr_num__(self, "value");
}


#line 19 "examples/basics.ks"
ks_val_t add(ks_val_t a, ks_val_t b) {
    return ks_v_add(a, b);
    return ks_none();
}

#line 23 "examples/basics.ks"
ks_val_t factorial(ks_val_t n) {
...
#line 4 "examples/basics.ks"
    ks_val_print(ks_str("=== KentScript Basics ===")); printf("\n");
#line 6 "examples/basics.ks"
    ks_val_print(ks_str("\n--- Variables ---")); printf("\n");
#line 8 "examples/basics.ks"
    ks_val_t x = KS_INT(42LL);
#line 9 "examples/basics.ks"
    ks_val_t pi = KS_FLT(3.14159);
#line 10 "examples/basics.ks"
    char* name = "KentScript";
#line 11 "examples/basics.ks"
    ks_val_t is_true = KS_BOOL(1);
#line 13 "examples/basics.ks"
    ks_val_print(ks_str(_ks_concat("x = ", ks_val_to_str(x)))); printf("\n");
#line 14 "examples/basics.ks"
    ks_val_print(ks_str(_ks_concat("pi = ", ks_val_to_str(pi)))); printf("\n");
#line 15 "examples/basics.ks"
    ks_val_print(ks_str(_ks_concat("is_true = ", ks_val_to_str(is_true)))); printf("\n");
#line 17 "examples/basics.ks"
    ks_val_print(ks_str("\n--- Functions ---")); printf("\n");
#line 30 "examples/basics.ks"
    ks_val_print(ks_str(_ks_concat("add(5, 3) = ", ks_val_to_str(add(KS_INT(5LL), KS_INT(3LL)))))); printf("\n");
#line 31 "examples/basics.ks"
    ks_val_print(ks_str(_ks_concat("factorial(5) = ", ks_val_to_str(factorial(KS_INT(5LL)))))); printf("\n");
#line 33 "examples/basics.ks"
    ks_val_print(ks_str("\n--- Control Flow ---")); printf("\n");
#line 35 "examples/basics.ks"
    ks_val_t test_val = KS_INT(10LL);
    if (ks_v_bool(ks_bool(ks_v_cmp(test_val, KS_INT(0LL)) > 0))) {
        ks_val_print(ks_str("test_val is positive")); printf("\n");
    } else if (ks_v_bool(ks_bool(ks_v_cmp(test_val, KS_INT(0LL)) < 0))) {
        ks_val_print(ks_str("test_val is negative")); printf("\n");
    } else {
        ks_val_print(ks_str("test_val is zero")); printf("\n");
    }
#line 44 "examples/basics.ks"
    ks_val_t i = KS_INT(0LL);
    while (ks_v_bool(ks_bool(ks_v_cmp(i, KS_INT(3LL)) < 0))) {
        ks_val_print(ks_str(_ks_concat("while loop: ", ks_val_to_str(i)))); printf("\n");
        i = ks_v_add(i, KS_INT(1LL));
    }
#line 50 "examples/basics.ks"
    ks_val_print(ks_str("for loop:")); printf("\n");
    for (long long j = 0; j < 3; j++) {
    ks_val_print(ks_str(_ks_concat("  j = ", _ks_str_int(j)))); printf("\n");
}
#line 55 "examples/basics.ks"
ks_val_print(ks_str("\n--- Classes (Python-style) ---")); printf("\n");
Calculator_t* calc = __new_Calculator__();
#line 72 "examples/basics.ks"
__method_Calculator_add__(calc, 5LL);
#line 73 "examples/basics.ks"
__method_Calculator_add__(calc, 3LL);
long long result = __method_Calculator_get_value__(calc);
#line 75 "examples/basics.ks"
ks_val_print(ks_str(_ks_concat("Calculator result: ", _ks_str_int(result)))); printf("\n");
#line 77 "examples/basics.ks"
ks_val_print(ks_str("\n--- Pattern Matching ---")); printf("\n");
#line 96 "examples/basics.ks"
ks_val_print(ks_str(_ks_concat("200: ", ks_val_to_str(http_status(KS_INT(200LL)))))); printf("\n");
#line 97 "examples/basics.ks"
ks_val_print(ks_str(_ks_concat("404: ", ks_val_to_str(http_status(KS_INT(404LL)))))); printf("\n");
#line 98 "examples/basics.ks"
ks_val_print(ks_str(_ks_concat("999: ", ks_val_to_str(http_status(KS_INT(999LL)))))); printf("\n");
#line 100 "examples/basics.ks"
ks_val_print(ks_str("\n--- Unsafe/Memory Operations ---")); printf("\n");
/* unsafe block */
{
    void* ptr = ks_malloc(KS_INT(64LL));
    ks_val_print(ks_str(_ks_concat("Allocated memory at: ", _ks_str_hex((long long)(uintptr_t)ptr)))); printf("\n");
    (ks_ptr_write((void*)ptr, 3735928559LL, 1), 0);
    ks_val_t val = ks_int((long long)(ks_ptr_read((void*)ptr, 8LL)));
    ks_val_print(ks_str("Value written: 0xDEADBEEF")); printf("\n");
    ks_val_print(ks_str(_ks_concat("Value read: 0x", _ks_str_hex(_ks_as_i(val))))); printf("\n");
    free((void*)ptr);
    ks_val_print(ks_str("Memory freed")); printf("\n");
}
#line 113 "examples/basics.ks"
ks_val_print(ks_str("\n=== All Examples Completed ===")); printf("\n");
return 0;
}