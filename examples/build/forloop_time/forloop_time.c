...
int main(int argc, char** argv) {
    ...
    _ks_init_globals();
    for (long long i = 0; i < 1000; i += 0) {
    ks_val_print(ks_int(i)); printf("\n");
}
#line 6 "/home/pylord/Desktop/KentScript/examples/forloop_time.ks"
double t2 = ks_time_seconds();
#line 7 "/home/pylord/Desktop/KentScript/examples/forloop_time.ks"
ks_val_t elapsed = ks_v_sub(ks_flt(t2), ks_flt(t1));
#line 8 "/home/pylord/Desktop/KentScript/examples/forloop_time.ks"
ks_val_t ms = ks_v_mul(elapsed, KS_FLT(1000.0));
if (ks_v_bool(ks_bool(ks_v_cmp(ms, KS_FLT(1000.0)) >= 0))) {
    ks_val_t secs = ks_v_div(ms, KS_FLT(1000.0));
    ks_val_print(ks_str("Completed in ")); printf("\n");
    ks_val_print(secs); printf("\n");
    ks_val_print(ks_str(" s (")); printf("\n");
    ks_val_print(ms); printf("\n");
    ks_val_print(ks_str(" ms)")); printf("\n");
} else {
    ks_val_print(ks_str("Completed in ")); printf("\n");
    ks_val_print(ms); printf("\n");
    ks_val_print(ks_str(" ms")); printf("\n");
