...
int main(int argc, char** argv) {
    ...
    /* unsafe block */
    {
        ks_val_t x = KS_INT(0LL);
        void* ptr = (&x);
        long long value = (*(long long*)(ptr));
    }
#line 21 "examples/c_compat_features.ks"
    /* struct Point */
    typedef struct {
        i32 x;
        i32 y;
    } Point_t;
#line 27 "examples/c_compat_features.ks"
    for (long long i = 0; i < 10; i++) {
    ks_val_print(ks_int(i)); printf("\n");
}
#line 41 "examples/c_compat_features.ks"
ks_val_t x = KS_INT(1LL);
{ /* switch */
    long long _sw_val = (long long)(x);
    case KS_INT(1LL):
...
#line 53 "examples/c_compat_features.ks"
x = KS_INT(42LL);
#line 54 "examples/c_compat_features.ks"
ks_val_t y = KS_INT(27LL);
#line 57 "examples/c_compat_features.ks"
ks_val_t a = ks_int((x) & (y));
#line 58 "examples/c_compat_features.ks"
ks_val_t b = ks_int((x) | (y));
#line 59 "examples/c_compat_features.ks"
ks_val_t c = ks_int((x) ^ (y));
#line 60 "examples/c_compat_features.ks"
ks_val_t d = ks_int(~((x).as.i));
#line 61 "examples/c_compat_features.ks"
ks_val_t e = ks_int((x) << (_ks_as_i(KS_INT(2LL))));
#line 62 "examples/c_compat_features.ks"
ks_val_t f = ks_int((x) >> (_ks_as_i(KS_INT(2LL))));
x = KS_INT(1LL);
x = KS_INT(1LL);
x = KS_INT(2LL);
x = ks_int((long long)(ks_v_div(x, KS_INT(2LL)).as.f));
x = KS_INT(3LL);
x = KS_INT(255LL);
x = KS_INT(1LL);
x = KS_INT(255LL);
x = KS_INT(1LL);
x = KS_INT(1LL);
x = ks_v_add(x, KS_INT(1LL));
#line 80 "examples/c_compat_features.ks"
ks_val_t max = __ternary__(ks_bool(ks_v_cmp(a, b) > 0), a, b);
#line 83 "examples/c_compat_features.ks"
ks_val_t size = sizeof(long long);
#line 84 "examples/c_compat_features.ks"
ks_val_t arr_size = sizeof(long long);
#line 88 "examples/c_compat_features.ks"
long long ch = ("A");
#line 89 "examples/c_compat_features.ks"
long long newline = ("\n");
/* unsafe block */
{
    __asm__("mov rax, 42");
