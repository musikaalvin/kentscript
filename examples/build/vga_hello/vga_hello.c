...
int main(int argc, char** argv) {
    ...
    /* unsafe block */
    {
        void* vga = ((void*)(uintptr_t)(_ks_as_i(KS_INT(753664LL))));
        char* msg = "Hello";
        for (long long i = 0; i < 5; i++) {
        (*(uint16_t*)(vga)) = (uint16_t)(_ks_as_i(ks_int((((long long)_ks_str_at(msg, i))) | (_ks_as_i(ks_int((_ks_as_i(KS_INT(15LL))) << (_ks_as_i(KS_INT(8LL)))))))));
        vga = ((void*)((uintptr_t)(vga) + (uintptr_t)(2LL)));
    }
}
return 0;
}