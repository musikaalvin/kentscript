...
ks_val_t buffer = {.tag = KS_T_INT, .as.i = 1024LL};
ks_val_t byte1 = {.tag = KS_T_INT, .as.i = 65LL};
ks_val_t byte2 = {.tag = KS_T_INT, .as.i = 66LL};
ks_val_t byte3 = {.tag = KS_T_INT, .as.i = 67LL};

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
#line 7 "examples/memory_example.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Bytes: ", ks_val_to_str(byte1)), " "), ks_val_to_str(byte2)), " "), ks_val_to_str(byte3)))); printf("\n");
#line 8 "examples/memory_example.ks"
    ks_val_print(ks_str(_ks_concat("Buffer size: ", ks_val_to_str(buffer)))); printf("\n");
#line 9 "examples/memory_example.ks"
    ks_val_print(ks_str("Memory allocated")); printf("\n");
    return 0;
}