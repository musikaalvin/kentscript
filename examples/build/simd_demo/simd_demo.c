...
#line 5 "examples/simd_demo.ks"
    ks_val_print(ks_str("=== KentScript Real SIMD ===")); printf("\n");
#line 6 "examples/simd_demo.ks"
    ks_val_print(ks_str(_ks_concat("arch: ", (ks_simd_arch_name())))); printf("\n");
#line 7 "examples/simd_demo.ks"
    long long wbytes = ((long long)ks_simd_width_bytes());
#line 8 "examples/simd_demo.ks"
    ks_val_print(ks_str(_ks_concat("simd width bytes: ", _ks_str_int(wbytes)))); printf("\n");
#line 10 "examples/simd_demo.ks"
    ks_val_t n = KS_INT(1024LL);
#line 13 "examples/simd_demo.ks"
    long long a = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
#line 14 "examples/simd_demo.ks"
    long long b = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
#line 15 "examples/simd_demo.ks"
    long long c = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
    for (long long i = 0; i < (n).as.i; i++) {
    ((float*)(a))[(i)] = (1.5);
    ((float*)(b))[(i)] = (2.5);
}
#line 22 "examples/simd_demo.ks"
ks_simd_f32_bin_add((float*)(a), (float*)(b), (float*)(c), (_ks_as_i(n)));
#line 23 "examples/simd_demo.ks"
ks_simd_scale_f32((float*)(c), (2.0), (_ks_as_i(n)));
#line 25 "examples/simd_demo.ks"
ks_val_t c0 = ks_flt(((float*)(c))[(0LL)]);
#line 26 "examples/simd_demo.ks"
ks_val_t csum = ks_flt(ks_simd_sum_f32((float*)(c), (_ks_as_i(n))));
#line 27 "examples/simd_demo.ks"
ks_val_t cdot = ks_flt(ks_simd_dot_f32((float*)(a), (float*)(b), (_ks_as_i(n))));
#line 28 "examples/simd_demo.ks"
ks_val_print(ks_str(_ks_concat("c[0]  = ", ks_val_to_str(c0)))); printf("\n");
#line 29 "examples/simd_demo.ks"
ks_val_print(ks_str(_ks_concat("sum   = ", ks_val_to_str(csum)))); printf("\n");
#line 30 "examples/simd_demo.ks"
ks_val_print(ks_str(_ks_concat("dot   = ", ks_val_to_str(cdot)))); printf("\n");
#line 31 "examples/simd_demo.ks"
ks_val_print(ks_str("exp c[0]=8.0  sum=8192.0  dot=3840.0")); printf("\n");
#line 34 "examples/simd_demo.ks"
long long x = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(long long));
#line 35 "examples/simd_demo.ks"
long long y = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(long long));
#line 36 "examples/simd_demo.ks"
long long z = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(long long));
for (long long i = 0; i < (n).as.i; i++) {
((long long*)(x))[(i)] = (i);
((long long*)(y))[(i)] = (2LL);
}
#line 43 "examples/simd_demo.ks"
ks_simd_i64_bin_mul((long long*)(x), (long long*)(y), (long long*)(z), (_ks_as_i(n)));
#line 44 "examples/simd_demo.ks"
ks_val_t z10 = ks_int(((long long*)(z))[(10LL)]);
#line 45 "examples/simd_demo.ks"
ks_val_t xyd = ks_int(ks_simd_dot_i64((long long*)(x), (long long*)(y), (_ks_as_i(n))));
#line 46 "examples/simd_demo.ks"
ks_val_print(ks_str(_ks_concat("z[10] = ", ks_val_to_str(z10)))); printf("\n");
#line 47 "examples/simd_demo.ks"
ks_val_print(ks_str(_ks_concat("dot   = ", ks_val_to_str(xyd)))); printf("\n");
#line 50 "examples/simd_demo.ks"
long long w = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(long long));
#line 51 "examples/simd_demo.ks"
ks_simd_fma_i64((long long*)(x), (long long*)(y), (long long*)(z), (long long*)(w), (_ks_as_i(n)));
#line 52 "examples/simd_demo.ks"
ks_val_t w7 = ks_int(((long long*)(w))[(7LL)]);
#line 53 "examples/simd_demo.ks"
ks_val_print(ks_str(_ks_concat("w[7]  = ", ks_val_to_str(w7)))); printf("\n");
#line 55 "examples/simd_demo.ks"
_ks_simd_free((void*)(a));
#line 55 "examples/simd_demo.ks"
_ks_simd_free((void*)(b));
#line 55 "examples/simd_demo.ks"
_ks_simd_free((void*)(c));
#line 56 "examples/simd_demo.ks"
_ks_simd_free((void*)(x));
#line 56 "examples/simd_demo.ks"
_ks_simd_free((void*)(y));
#line 56 "examples/simd_demo.ks"
_ks_simd_free((void*)(z));
#line 57 "examples/simd_demo.ks"
_ks_simd_free((void*)(w));
#line 58 "examples/simd_demo.ks"
ks_val_print(ks_str("=== done ===")); printf("\n");
return 0;
}