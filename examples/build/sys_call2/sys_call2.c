...
int main(int argc, char** argv) {
    ...
    /* unsafe block */
    {
        void* ptr = ks_malloc(KS_INT(512LL));
        write_byte((void*)ptr, ks_v_i(KS_INT(0LL)), ks_v_i(KS_INT(65LL)));
        write_byte((void*)ptr, ks_v_i(KS_INT(1LL)), ks_v_i(KS_INT(66LL)));
        write_byte((void*)ptr, ks_v_i(KS_INT(2LL)), ks_v_i(KS_INT(67LL)));
        long long a = read_byte((void*)ptr, ks_v_i(KS_INT(0LL)));
        long long b = read_byte((void*)ptr, ks_v_i(KS_INT(1LL)));
        long long c = read_byte((void*)ptr, ks_v_i(KS_INT(2LL)));
        ks_val_print(ks_str("Values:")); printf(" "); ks_val_print(ks_int(a)); printf(" "); ks_val_print(ks_int(b)); printf(" "); ks_val_print(ks_int(c)); printf("\n");
        free((void*)ptr);
    }
    return 0;
}