...
void _ks_init_globals(void) {
    window = _ks_create_window(gui, "My App", KS_INT(400LL), KS_INT(300LL));
    label = _ks_create_label(gui, window, "Enter your name:");
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    _ks_init_globals();
#line 7 "examples/simple_gui.ks"
    _ks_pack(gui, label);
#line 9 "examples/simple_gui.ks"
    long long entry = _ks_create_entry(gui, window);
#line 10 "examples/simple_gui.ks"
    _ks_pack(gui, entry);
#line 12 "examples/simple_gui.ks"
    long long button = _ks_create_button(gui, window, "Submit", &_ks_lambda_unknown);
#line 16 "examples/simple_gui.ks"
    _ks_pack(gui, button);
#line 18 "examples/simple_gui.ks"
