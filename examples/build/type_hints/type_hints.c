...
ks_val_t multiply(ks_val_t x, ks_val_t y);
ks_val_t greet(ks_val_t name);

char* name = "KentScript";
ks_val_t version = {.tag = KS_T_INT, .as.i = 4LL};
double pi = 3.14159;

#line 5 "examples/type_hints.ks"
ks_val_t add(ks_val_t a, ks_val_t b) {
    return ks_v_add(a, b);
    return ks_none();
}

#line 10 "examples/type_hints.ks"
ks_val_t multiply(ks_val_t x, ks_val_t y) {
    return ks_v_mul(x, y);
    return ks_none();
}

#line 28 "examples/type_hints.ks"
ks_val_t greet(ks_val_t name) {
...
#line 19 "examples/type_hints.ks"
    ks_val_print(ks_str("Addition: ")); printf(" "); ks_val_print(add(KS_INT(5LL), KS_INT(3LL))); printf("\n");
#line 20 "examples/type_hints.ks"
    ks_val_print(ks_str("Multiplication: ")); printf(" "); ks_val_print(multiply(KS_FLT(2.5), KS_FLT(4.0))); printf("\n");
#line 22 "examples/type_hints.ks"
    ks_val_print(ks_str("\nTyped variables:")); printf("\n");
#line 23 "examples/type_hints.ks"
    ks_val_print(ks_str("Name: ")); printf(" "); ks_val_print(ks_str(name)); printf("\n");
#line 24 "examples/type_hints.ks"
    ks_val_print(ks_str("Version: ")); printf(" "); ks_val_print(version); printf("\n");
#line 25 "examples/type_hints.ks"
    ks_val_print(ks_str("Pi: ")); printf(" "); ks_val_print(ks_flt(pi)); printf("\n");
#line 32 "examples/type_hints.ks"
    ks_val_print(ks_str("\n")); printf(" "); ks_val_print(greet(ks_str(("World")))); printf("\n");
#line 34 "examples/type_hints.ks"
    ks_val_print(ks_str("\n✓ Type hints working! (documentation only in v4.0)")); printf("\n");
    return 0;
}