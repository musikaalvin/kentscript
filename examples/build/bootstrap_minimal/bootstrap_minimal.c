...
ks_val_t lex_simple(ks_val_t source);
ks_val_t parse_simple(ks_val_t tokens);
ks_val_t codegen_simple(ks_val_t ast);
ks_val_t compile(ks_val_t source);

#line 4 "examples/bootstrap_minimal.ks"
ks_val_t lex_simple(ks_val_t source) {
    ks_val_t count = KS_INT(0LL);
    ks_val_t i = KS_INT(0LL);
    while (ks_v_bool(ks_bool(ks_v_cmp(i, KS_INT(100LL)) < 0))) {
...
#line 17 "examples/bootstrap_minimal.ks"
ks_val_t parse_simple(ks_val_t tokens) {
    return ks_v_mul(tokens, KS_INT(2LL));
    return ks_none();
}

#line 22 "examples/bootstrap_minimal.ks"
ks_val_t codegen_simple(ks_val_t ast) {
    return ks_str("Generated code");
    return ks_none();
}

#line 27 "examples/bootstrap_minimal.ks"
ks_val_t compile(ks_val_t source) {
    ks_val_t tokens = lex_simple(source);
    ks_val_t ast = parse_simple(tokens);
    ks_val_t code = codegen_simple(ast);
    return code;
    return ks_none();
}
...
#line 36 "examples/bootstrap_minimal.ks"
    ks_val_print(ks_str("=== KentScript Bootstrap Compiler ===")); printf("\n");
#line 37 "examples/bootstrap_minimal.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 39 "examples/bootstrap_minimal.ks"
    char* source = "let x = 42;";
#line 40 "examples/bootstrap_minimal.ks"
    ks_val_print(ks_str(_ks_concat("Compiling: ", source))); printf("\n");
#line 42 "examples/bootstrap_minimal.ks"
    ks_val_t result = compile(ks_str((source)));
#line 43 "examples/bootstrap_minimal.ks"
    ks_val_print(ks_str(_ks_concat("Result: ", ks_val_to_str(result)))); printf("\n");
#line 45 "examples/bootstrap_minimal.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 46 "examples/bootstrap_minimal.ks"
    ks_val_print(ks_str("✓ Bootstrap successful!")); printf("\n");
#line 47 "examples/bootstrap_minimal.ks"
    ks_val_print(ks_str("✓ KentScript compiled by KentScript!")); printf("\n");
    return 0;
}