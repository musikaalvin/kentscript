...
ks_val_t x = {.tag = KS_T_INT, .as.i = 42LL};
ks_val_t y;
...
int main(int argc, char** argv) {
    ...
    _ks_init_globals();
#line 8 "examples/borrow_test.ks"
    ks_val_print(y); printf("\n");
#line 11 "examples/borrow_test.ks"
    static ks_val_t _arr_data[] = {(ks_val_t){.tag=KS_T_INT,.as.i=1LL}, (ks_val_t){.tag=KS_T_INT,.as.i=2LL}, (ks_val_t){.tag=KS_T_INT,.as.i=3LL}};
    ks_array data = { .data = _arr_data, .length = 3 };
#line 12 "examples/borrow_test.ks"
    ks_array r1 = data;
#line 13 "examples/borrow_test.ks"
    ks_array r2 = data;
#line 14 "examples/borrow_test.ks"
    ks_val_print(ks_array_get(r1, KS_INT(0LL))); printf("\n");
#line 15 "examples/borrow_test.ks"
    ks_val_print(ks_array_get(r2, KS_INT(1LL))); printf("\n");
#line 20 "examples/borrow_test.ks"
    ks_val_t counter = KS_INT(0LL);
#line 21 "examples/borrow_test.ks"
    ks_val_t m = counter;
    counter = ks_v_add(counter, KS_INT(1LL));
#line 23 "examples/borrow_test.ks"
    ks_val_print(counter); printf("\n");
#line 27 "examples/borrow_test.ks"
    ks_val_print(ks_str("✅ Borrow checker works!")); printf("\n");
    return 0;
}