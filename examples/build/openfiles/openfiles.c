...
void _ks_init_globals(void) {
    fd = _ks_syscall_open("/home/pylord/Documents/apikeys.txt", _ks_as_i(KS_INT(0LL)));
    data = 0;
}
...
int main(int argc, char** argv) {
    ...
    _ks_init_globals();
#line 10 "examples/openfiles.ks"
    ks_val_print(ks_int(data)); printf("\n");
#line 13 "examples/openfiles.ks"
