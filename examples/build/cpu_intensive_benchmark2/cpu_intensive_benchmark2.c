...
int main(int argc, char** argv) {
    ...
    sum = ks_v_add(ks_flt(sum), ks_v_div(ks_v_mul(ks_int(i), ks_int(i)), KS_FLT(3.0)));
}
#line 11 "examples/cpu_intensive_benchmark2.ks"
double end = ks_time_seconds();
#line 12 "examples/cpu_intensive_benchmark2.ks"
ks_val_print(ks_str(_ks_concat("Native Result: ", _ks_str_dbl(sum)))); printf("\n");
#line 13 "examples/cpu_intensive_benchmark2.ks"
ks_val_print(ks_str(_ks_concat(_ks_concat("Native Time: ", ks_val_to_str(ks_v_sub(ks_flt(end), ks_flt(start)))), " ms"))); printf("\n");
return 0;
}