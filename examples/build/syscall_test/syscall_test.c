...
#line 11 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 1: Process ID ===")); printf("\n");
#line 12 "examples/syscall_test.ks"
    long long pid = _ks_syscall_getpid();
#line 13 "examples/syscall_test.ks"
    ks_val_print(ks_str("Current PID: ")); printf(" "); ks_val_print(ks_int(pid)); printf("\n");
#line 18 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 19 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 2: Thread ID ===")); printf("\n");
#line 20 "examples/syscall_test.ks"
    long long tid = 0;
#line 21 "examples/syscall_test.ks"
    ks_val_print(ks_str("Current TID: ")); printf(" "); ks_val_print(ks_int(tid)); printf("\n");
#line 26 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 27 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 3: Current Directory ===")); printf("\n");
#line 28 "examples/syscall_test.ks"
    long long cwd = 0;
#line 29 "examples/syscall_test.ks"
    ks_val_print(ks_str("CWD: ")); printf(" "); ks_val_print(ks_int(cwd)); printf("\n");
#line 34 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 35 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 4: File Operations ===")); printf("\n");
#line 38 "examples/syscall_test.ks"
    char* testfile = "/tmp/kentscript_test.txt";
#line 39 "examples/syscall_test.ks"
    long long fd = _ks_syscall_open(testfile, _ks_as_i(KS_INT(438LL)));
#line 40 "examples/syscall_test.ks"
    ks_val_print(ks_str("Opened file: ")); printf(" "); ks_val_print(ks_str(testfile)); printf("\n");
#line 41 "examples/syscall_test.ks"
    ks_val_print(ks_str("File descriptor: ")); printf(" "); ks_val_print(ks_int(fd)); printf("\n");
#line 44 "examples/syscall_test.ks"
    char* message = "KentScript talks to Linux kernel!";
#line 45 "examples/syscall_test.ks"
    long long bytes_written = _ks_syscall_write(fd, message);
#line 46 "examples/syscall_test.ks"
    ks_val_print(ks_str("Wrote ")); printf(" "); ks_val_print(ks_int(bytes_written)); printf(" "); ks_val_print(ks_str(" bytes")); printf("\n");
#line 49 "examples/syscall_test.ks"
    _ks_syscall_close(fd);
#line 50 "examples/syscall_test.ks"
    ks_val_print(ks_str("File closed")); printf("\n");
#line 55 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 56 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 5: File Stats ===")); printf("\n");
#line 57 "examples/syscall_test.ks"
    _ks_dict* stats = _ks_syscall_stat(testfile);
#line 58 "examples/syscall_test.ks"
    ks_val_print(ks_str("File size: ")); printf(" "); ks_val_print(ks_int(_ks_dict_get_simple(stats, "size"))); printf("\n");
#line 59 "examples/syscall_test.ks"
    ks_val_print(ks_str("File mode: ")); printf(" "); ks_val_print(ks_int(_ks_dict_get_simple(stats, "mode"))); printf("\n");
#line 64 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 65 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 6: Real Memory ===")); printf("\n");
    /* unsafe block */
    {
        void* mem = ks_malloc(KS_INT(256LL));
        ks_val_print(ks_str("Allocated memory at: ")); printf(" "); ks_val_print(ks_obj((void*)(mem))); printf("\n");
        write_string(mem, KS_INT(0LL), "Hello Kernel!");
        ks_val_t str = read_string(mem, KS_INT(0LL));
        ks_val_print(ks_str("String from memory: ")); printf(" "); ks_val_print(str); printf("\n");
        free((void*)mem);
        ks_val_print(ks_str("Memory freed")); printf("\n");
    }
#line 87 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 88 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 7: Math with Syscalls ===")); printf("\n");
#line 89 "examples/syscall_test.ks"
    long long pid1 = _ks_syscall_getpid();
#line 90 "examples/syscall_test.ks"
    long long pid2 = _ks_syscall_getpid();
#line 91 "examples/syscall_test.ks"
    ks_val_print(ks_str("PID + PID = ")); printf(" "); ks_val_print(ks_v_add(ks_int(pid1), ks_int(pid2))); printf("\n");
#line 96 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 97 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 8: Directory Info ===")); printf("\n");
#line 98 "examples/syscall_test.ks"
    long long home_dir = 0;
#line 99 "examples/syscall_test.ks"
    ks_val_print(ks_str("Home directory: ")); printf(" "); ks_val_print(ks_int(home_dir)); printf("\n");
#line 104 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 105 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 9: Syscall Chain ===")); printf("\n");
#line 106 "examples/syscall_test.ks"
    ks_val_print(ks_str("Process ID: ")); printf(" "); ks_val_print(ks_int(_ks_syscall_getpid())); printf("\n");
#line 107 "examples/syscall_test.ks"
    ks_val_print(ks_str("Current Dir: ")); printf(" "); ks_val_print(0); printf("\n");
#line 108 "examples/syscall_test.ks"
    ks_val_print(ks_str("Thread ID: ")); printf(" "); ks_val_print(0); printf("\n");
#line 113 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 114 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== Test 10: Full File Example ===")); printf("\n");
#line 116 "examples/syscall_test.ks"
    char* filename = "/tmp/ks_syscall_demo.txt";
#line 119 "examples/syscall_test.ks"
    long long out_fd = _ks_syscall_open(filename, _ks_as_i(KS_INT(438LL)));
#line 120 "examples/syscall_test.ks"
    ks_val_print(ks_str("Created: ")); printf(" "); ks_val_print(ks_str(filename)); printf("\n");
#line 122 "examples/syscall_test.ks"
    char* content = "Line 1: KentScript\nLine 2: Real Syscalls\nLine 3: Direct Kernel Access";
#line 123 "examples/syscall_test.ks"
    _ks_syscall_write(out_fd, content);
#line 124 "examples/syscall_test.ks"
    ks_val_print(ks_str("Written ")); printf(" "); ks_val_print(_ks_len(content)); printf(" "); ks_val_print(ks_str(" characters")); printf("\n");
#line 125 "examples/syscall_test.ks"
    _ks_syscall_close(out_fd);
#line 128 "examples/syscall_test.ks"
    _ks_dict* fstats = _ks_syscall_stat(filename);
#line 129 "examples/syscall_test.ks"
    ks_val_print(ks_str("File size: ")); printf(" "); ks_val_print(ks_int(_ks_dict_get_simple(fstats, "size"))); printf(" "); ks_val_print(ks_str(" bytes")); printf("\n");
#line 131 "examples/syscall_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 132 "examples/syscall_test.ks"
    ks_val_print(ks_str("=== All Tests Complete ===")); printf("\n");
#line 133 "examples/syscall_test.ks"
    ks_val_print(ks_str("KentScript successfully called Linux kernel syscalls!")); printf("\n");
    return 0;
}