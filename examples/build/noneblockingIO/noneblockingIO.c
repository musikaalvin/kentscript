...
int main(int argc, char** argv) {
    ...
    _ks_init_globals();
#line 4 "examples/noneblockingIO.ks"
    _ks_enqueue_macrotask(loop, file_read_operation);
#line 7 "examples/noneblockingIO.ks"
    _ks_enqueue_gui_event(loop, "click", button_handler);
#line 10 "examples/noneblockingIO.ks"
    _ks_set_timeout(loop, callback, KS_INT(1000LL));
#line 13 "examples/noneblockingIO.ks"
    _ks_run(loop);
    return 0;
}