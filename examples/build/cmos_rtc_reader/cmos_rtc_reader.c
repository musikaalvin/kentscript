...
ks_val_t read_rtc_register(ks_val_t reg_num);
ks_val_t get_seconds(void);
ks_val_t get_minutes(void);
ks_val_t get_hours(void);
ks_val_t get_day(void);
ks_val_t get_month(void);
ks_val_t get_year(void);

#line 3 "examples/cmos_rtc_reader.ks"
ks_val_t read_rtc_register(ks_val_t reg_num) {
    _ks_write_port(hardware, KS_INT(112LL), reg_num);
    long long value = _ks_read_port(hardware, KS_INT(113LL));
    return value;
    return ks_none();
}

#line 11 "examples/cmos_rtc_reader.ks"
ks_val_t get_seconds(void) {
    return read_rtc_register(KS_INT(0LL));
    return ks_none();
}

#line 15 "examples/cmos_rtc_reader.ks"
ks_val_t get_minutes(void) {
    return read_rtc_register(KS_INT(2LL));
    return ks_none();
}

#line 19 "examples/cmos_rtc_reader.ks"
ks_val_t get_hours(void) {
    return read_rtc_register(KS_INT(4LL));
    return ks_none();
}

#line 23 "examples/cmos_rtc_reader.ks"
ks_val_t get_day(void) {
    return read_rtc_register(KS_INT(7LL));
    return ks_none();
}

#line 27 "examples/cmos_rtc_reader.ks"
ks_val_t get_month(void) {
    return read_rtc_register(KS_INT(8LL));
    return ks_none();
}

#line 31 "examples/cmos_rtc_reader.ks"
ks_val_t get_year(void) {
    return read_rtc_register(KS_INT(9LL));
    return ks_none();
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
#line 35 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("╔═══════════════════════════════════════════╗")); printf("\n");
#line 36 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("║  KentScript CMOS RTC Clock Reader v1.0   ║")); printf("\n");
#line 37 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("║  Reading RTC via I/O Ports 0x70/0x71     ║")); printf("\n");
#line 38 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("╚═══════════════════════════════════════════╝")); printf("\n");
#line 39 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("═══════════════════════════════════════════")); printf("\n");
#line 40 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("CMOS RTC TIME & DATE")); printf("\n");
#line 41 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("═══════════════════════════════════════════")); printf("\n");
#line 43 "examples/cmos_rtc_reader.ks"
    ks_val_t s = get_seconds();
#line 44 "examples/cmos_rtc_reader.ks"
    ks_val_t m = get_minutes();
#line 45 "examples/cmos_rtc_reader.ks"
    ks_val_t h = get_hours();
#line 47 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Time: ", ks_val_to_str(h)), ":"), ks_val_to_str(m)), ":"), ks_val_to_str(s)))); printf("\n");
#line 49 "examples/cmos_rtc_reader.ks"
    ks_val_t d = get_day();
#line 50 "examples/cmos_rtc_reader.ks"
    ks_val_t mo = get_month();
#line 51 "examples/cmos_rtc_reader.ks"
    ks_val_t y = get_year();
#line 53 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Date: ", ks_val_to_str(mo)), "/"), ks_val_to_str(d)), "/"), ks_val_to_str(y)))); printf("\n");
#line 55 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("═══════════════════════════════════════════")); printf("\n");
#line 56 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("✓ RTC Read Complete")); printf("\n");
#line 57 "examples/cmos_rtc_reader.ks"
    ks_val_print(ks_str("═══════════════════════════════════════════")); printf("\n");
    return 0;
}