...
static long long _ks_anon_0(long long a, long long b) {
    return _ks_as_i(ks_v_add(ks_int(a), ks_int(b)));
    return 0LL;
}

static long long _ks_anon_1(long long a, long long b) {
    return _ks_as_i(ks_v_mul(ks_int(a), ks_int(b)));
    return 0LL;
}

typedef struct {
    long long* fib;  /* captured by ref */
} _cls__ks_anon_2;
static _cls__ks_anon_2 _ks_anon_2_env;
static long long _ks_anon_2_inner(_cls__ks_anon_2* _cls, long long n) {
    long long* fib = _cls->fib;  /* ptr to outer var */
    #define fib (*fib)
    if (ks_v_bool(ks_bool(ks_v_cmp(ks_int(n), KS_INT(1LL)) <= 0))) {
        return n;
    }
    return ks_v_add(fib(ks_v_sub(ks_int(n), KS_INT(1LL))), fib(ks_v_sub(ks_int(n), KS_INT(2LL))));
    #undef fib
    return 0LL;
}
static long long _ks_anon_2(long long n) {
    return _ks_anon_2_inner(&_ks_anon_2_env, n);
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
#line 9 "examples/full_demo.ks"
    ks_val_print(ks_str("╔══════════════════════════════════════════╗")); printf("\n");
#line 10 "examples/full_demo.ks"
    ks_val_print(ks_str("║     KENTSCRIPT CAPABILITIES DEMO        ║")); printf("\n");
#line 11 "examples/full_demo.ks"
    ks_val_print(ks_str("╚══════════════════════════════════════════╝")); printf("\n");
#line 12 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 14 "examples/full_demo.ks"
    ks_val_print(ks_str("=== 1. BASIC TYPES ===")); printf("\n");
#line 15 "examples/full_demo.ks"
    ks_val_t num = KS_INT(42LL);
#line 16 "examples/full_demo.ks"
    ks_val_t flt = KS_FLT(3.14);
#line 17 "examples/full_demo.ks"
    char* greeting = "Hello";
#line 18 "examples/full_demo.ks"
    ks_val_t flag = KS_BOOL(1);
#line 19 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("Integer: ", ks_val_to_str(num)))); printf("\n");
#line 20 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("Float: ", ks_val_to_str(flt)))); printf("\n");
#line 21 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("String: ", greeting))); printf("\n");
#line 22 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("Boolean: ", ks_val_to_str(flag)))); printf("\n");
#line 23 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 25 "examples/full_demo.ks"
    ks_val_print(ks_str("=== 2. FUNCTIONS ===")); printf("\n");
#line 26 "examples/full_demo.ks"
    long long (*add)(long long, long long) = (long long(*)(long long, long long))_ks_anon_0;
#line 27 "examples/full_demo.ks"
    long long (*multiply)(long long, long long) = (long long(*)(long long, long long))_ks_anon_1;
#line 28 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("add(3, 5) = ", add(KS_INT(3LL), KS_INT(5LL))))); printf("\n");
#line 29 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("multiply(4, 7) = ", multiply(KS_INT(4LL), KS_INT(7LL))))); printf("\n");
#line 30 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 32 "examples/full_demo.ks"
    ks_val_print(ks_str("=== 3. CONTROL FLOW ===")); printf("\n");
#line 33 "examples/full_demo.ks"
    ks_val_t x = KS_INT(5LL);
    if (ks_v_bool(ks_bool(ks_v_cmp(x, KS_INT(3LL)) > 0))) {
        ks_val_print(ks_str("x > 3 is true")); printf("\n");
    }
#line 36 "examples/full_demo.ks"
    ks_val_t sum = KS_INT(0LL);
#line 37 "examples/full_demo.ks"
    ks_val_t i = KS_INT(0LL);
    while (ks_v_bool(ks_bool(ks_v_cmp(i, KS_INT(10LL)) < 0))) {
        sum = ks_v_add(sum, i);
        i = ks_v_add(i, KS_INT(1LL));
    }
#line 39 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("While sum(0-9): ", ks_val_to_str(sum)))); printf("\n");
#line 40 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 42 "examples/full_demo.ks"
    ks_val_print(ks_str("=== 4. MATH ===")); printf("\n");
#line 43 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("sqrt(16): ", _ks_str_dbl(sqrt(16.0))))); printf("\n");
#line 44 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("sin(0): ", _ks_str_dbl(sin(0.0))))); printf("\n");
#line 45 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("pow(2, 8): ", _ks_str_dbl(pow(2.0, 8.0))))); printf("\n");
#line 46 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("abs(-42): ", _ks_str_dbl(abs(ks_v_f(ks_v_neg(KS_INT(42LL)))))))); printf("\n");
#line 47 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 49 "examples/full_demo.ks"
    ks_val_print(ks_str("=== 5. RANDOM ===")); printf("\n");
#line 50 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("random(): ", ks_val_to_str(ks_flt(system_random_uniform(0.0, 1.0)))))); printf("\n");
#line 51 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("randint(1,100): ", _ks_str_int(system_random_randint(_ks_as_i(KS_INT(1LL)), _ks_as_i(KS_INT(100LL))))))); printf("\n");
#line 52 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 54 "examples/full_demo.ks"
    ks_val_print(ks_str("=== 6. STRING OPS ===")); printf("\n");
#line 55 "examples/full_demo.ks"
    char* s1 = "Hello";
#line 56 "examples/full_demo.ks"
    char* s2 = "World";
#line 57 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("s1 + s2: ", s1), " "), s2))); printf("\n");
#line 58 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("len(s1): ", _ks_str_int(_ks_len(s1))))); printf("\n");
#line 59 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 61 "examples/full_demo.ks"
    ks_val_print(ks_str("=== 7. BENCHMARK ===")); printf("\n");
#line 62 "examples/full_demo.ks"
    double start = ks_time_seconds();
#line 63 "examples/full_demo.ks"
    ks_val_t result = KS_INT(0LL);
#line 64 "examples/full_demo.ks"
    ks_val_t n = KS_INT(0LL);
    while (ks_v_bool(ks_bool(ks_v_cmp(n, KS_INT(500000LL)) < 0))) {
        result = ks_v_sub(ks_v_add(result, ks_v_mul(n, n)), ks_v_div(n, KS_INT(2LL)));
        n = ks_v_add(n, KS_INT(1LL));
    }
#line 69 "examples/full_demo.ks"
    ks_val_t elapsed = ks_v_sub(ks_flt(ks_time_seconds()), ks_flt(start));
#line 70 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Integer loop (500K): ", ks_val_to_str(elapsed)), " seconds"))); printf("\n");
#line 71 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("Result: ", ks_val_to_str(result)))); printf("\n");
#line 72 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 74 "examples/full_demo.ks"
    ks_val_print(ks_str("=== 8. RECURSION ===")); printf("\n");
#line 75 "examples/full_demo.ks"
    long long (*fib)(long long) = (long long(*)(long long))_ks_anon_2;
    _ks_anon_2_env.fib = &fib;
#line 79 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("fib(10): ", fib(KS_INT(10LL))))); printf("\n");
#line 80 "examples/full_demo.ks"
    ks_val_print(ks_str(_ks_concat("fib(12): ", fib(KS_INT(12LL))))); printf("\n");
#line 81 "examples/full_demo.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 83 "examples/full_demo.ks"
    ks_val_print(ks_str("╔══════════════════════════════════════════╗")); printf("\n");
#line 84 "examples/full_demo.ks"
    ks_val_print(ks_str("║         ALL TESTS COMPLETE!             ║")); printf("\n");
#line 85 "examples/full_demo.ks"
    ks_val_print(ks_str("╚══════════════════════════════════════════╝")); printf("\n");
    return 0;
}