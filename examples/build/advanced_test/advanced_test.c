...
void describe(ks_val_t x);

#line 4 "examples/advanced_test.ks"
void describe(ks_val_t x) {
    { /* match statement */
        ks_val_t _match_v = x;
        if (ks_v_cmp(_match_v, KS_INT(1LL)) == 0) {
            ...
            ks_val_print(ks_str(_ks_concat("Value: ", ks_val_to_str(x)))); printf("\n");
        }
    }
}
...
#line 12 "examples/advanced_test.ks"
    describe(KS_INT(1LL));
#line 13 "examples/advanced_test.ks"
    describe(KS_INT(2LL));
#line 14 "examples/advanced_test.ks"
    describe(KS_INT(42LL));
    long long _n__lc_tmp_0 = (5) - (0);
    ...
    for (long long x = 0, _k__lc_tmp_0 = 0; _k__lc_tmp_0 < _n__lc_tmp_0; x++, _k__lc_tmp_0++) {
        _lc_tmp_0.data[_k__lc_tmp_0] = ks_v_mul(ks_int(x), KS_INT(2LL));
    }
    _lc_tmp_0.length = _n__lc_tmp_0;
    ks_array nums = _lc_tmp_0;
#line 18 "examples/advanced_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 19 "examples/advanced_test.ks"
    ks_val_print(ks_str("Doubled numbers:")); printf("\n");
    ks_val_t i = KS_INT(0LL);
    while (ks_v_bool(ks_bool(ks_v_cmp(i, ks_int(nums.length)) < 0))) {
        ks_val_print(ks_str(ks_val_to_str(ks_array_get(nums, i)))); printf("\n");
        i = ks_v_add(i, KS_INT(1LL));
    }
#line 26 "examples/advanced_test.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 27 "examples/advanced_test.ks"
    ks_val_print(ks_str("=== All tests passed! ===")); printf("\n");
    return 0;
}