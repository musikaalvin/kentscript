...
#line 2 "examples/progress.ks"
    ks_val_print(_ks_progress_bar_cyber(KS_INT(65LL), KS_INT(20LL), "magenta")); printf("\n");
#line 3 "examples/progress.ks"
    ks_val_print(_ks_progress_bar_matrix(KS_INT(90LL), KS_INT(15LL))); printf("\n");
    return 0;
}