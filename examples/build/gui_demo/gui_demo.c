...
#line 15 "examples/gui_demo.ks"
void show_text(void) {
    long long txt = _ks_get_text(gui, entry);
    _ks_set_text(gui, result_lbl, _ks_concat("You typed: ", ks_val_to_str(ks_int(txt))));
}

#line 23 "examples/gui_demo.ks"
void do_msg(void) {
    _ks_message_box(gui, "KentScript", "GUI works!", "info");
}

void _ks_init_globals(void) {
    win = _ks_create_window(gui, "KentScript GUI Demo", KS_INT(350LL), KS_INT(250LL));
    lbl = _ks_create_label(gui, win, "Hello from KentScript!");
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    _ks_init_globals();
#line 7 "examples/gui_demo.ks"
    _ks_pack(gui, lbl);
#line 9 "examples/gui_demo.ks"
    long long entry = _ks_create_entry(gui, win);
#line 10 "examples/gui_demo.ks"
    _ks_pack(gui, entry);
#line 12 "examples/gui_demo.ks"
    long long result_lbl = _ks_create_label(gui, win, "Type something:");
#line 13 "examples/gui_demo.ks"
    _ks_pack(gui, result_lbl);
#line 20 "examples/gui_demo.ks"
    long long btn = _ks_create_button(gui, win, "Show Text", show_text);
#line 21 "examples/gui_demo.ks"
    _ks_pack(gui, btn);
#line 27 "examples/gui_demo.ks"
    long long btn2 = _ks_create_button(gui, win, "Message", do_msg);
#line 28 "examples/gui_demo.ks"
    _ks_pack(gui, btn2);
#line 30 "examples/gui_demo.ks"
