...
static PortScanner_t* __new_PortScanner__(void) {
    PortScanner_t* self = (PortScanner_t*)malloc(sizeof(PortScanner_t));
    self->__class__ = "PortScanner";
    self->__attr_count__ = 0;
    memset(self->__attr_is_str__, 0, sizeof(self->__attr_is_str__));
    return self;
}

static char* __get_PortScanner_attr__(PortScanner_t* self, const char* name) {
...
static long long __get_PortScanner_attr_num__(PortScanner_t* self, const char* name) {
    for (int i = 0; i < self->__attr_count__; i++) {
        if (strcmp(self->__attr_names__[i], name) == 0) {
...
static void __set_PortScanner_attr__(PortScanner_t* self, const char* name, long long value) {
    for (int i = 0; i < self->__attr_count__; i++) {
        if (strcmp(self->__attr_names__[i], name) == 0) {
...
static char* __method_PortScanner_get_help__(PortScanner_t* self) {
...
static long long __method_PortScanner__parse_ports__(PortScanner_t* self, long long port_str) {
    ks_array ports = { .data = NULL, .length = 0 };
    static ks_val_t _arr_common_ports[] = {(ks_val_t){.tag=KS_T_INT,.as.i=21LL}, (ks_val_t){.tag=KS_T_INT,.as.i=22LL}, (ks_val_t){.tag=KS_T_INT,.as.i=23LL}, (ks_val_t){.tag=KS_T_INT,.as.i=25LL}, (ks_val_t){.tag=KS_T_INT,.as.i=53LL}, (ks_val_t){.tag=KS_T_INT,.as.i=80LL}, (ks_val_t){.tag=KS_T_INT,.as.i=110LL}, (ks_val_t){.tag=KS_T_INT,.as.i=111LL}, (ks_val_t){.tag=KS_T_INT,.as.i=135LL}, (ks_val_t){.tag=KS_T_INT,.as.i=139LL}, (ks_val_t){.tag=KS_T_INT,.as.i=143LL}, (ks_val_t){.tag=KS_T_INT,.as.i=443LL}, (ks_val_t){.tag=KS_T_INT,.as.i=445LL}, (ks_val_t){.tag=KS_T_INT,.as.i=993LL}, (ks_val_t){.tag=KS_T_INT,.as.i=995LL}, (ks_val_t){.tag=KS_T_INT,.as.i=1723LL}, (ks_val_t){.tag=KS_T_INT,.as.i=3306LL}, (ks_val_t){.tag=KS_T_INT,.as.i=3389LL}, (ks_val_t){.tag=KS_T_INT,.as.i=5900LL}, (ks_val_t){.tag=KS_T_INT,.as.i=8080LL}, (ks_val_t){.tag=KS_T_INT,.as.i=8443LL}};
    ks_array common_ports = { .data = _arr_common_ports, .length = 21 };
    if (__builtin_expect((ks_v_bool(ks_bool(ks_v_cmp(_ks_str_lower(ks_val_to_str(ks_int(port_str))), ks_str(("common"))) == 0))), 0)) {
        return common_ports;
    }
    parts = _ks_str_split(ks_val_to_str(ks_int(port_str)), ",");
    ks_array _iter__idx_part = parts;
    for (long long _idx_part = 0; _idx_part < _iter__idx_part.length; _idx_part++) {
        ks_val_t part = ks_array_get(_iter__idx_part, ks_int((long long)(_idx_part)));
        part = _ks_str_trim(ks_val_to_str(part));
        if (ks_v_bool(_ks_dict_contains(part, "-"))) {
            range_parts = _ks_str_split(ks_val_to_str(part), "-");
            ks_val_t start = ks_int((long long)(atoll(ks_array_get(range_parts, KS_INT(0LL)))));
            ks_val_t end = ks_int((long long)(atoll(ks_array_get(range_parts, KS_INT(1LL)))));
            ks_val_t i = start;
            while (ks_v_bool(ks_bool(ks_v_cmp(i, end) <= 0))) {
                (_ks_array_append(&ports, i), 0);
                i = ks_v_add(i, KS_INT(1LL));
            }
        } else {
            (_ks_array_append(&ports, atoll(part)), 0);
        }
    }
    _ks_sort(ports);
    return ports;
...
static char* __method_PortScanner__get_service_name__(PortScanner_t* self, long long port) {
    _ks_dict* common_services = ({ _ks_dict* _tmp_dict_1 = _ks_dict_new(); _ks_dict_set(_tmp_dict_1, "21", (long long)(uintptr_t)"FTP", 1); _ks_dict_set(_tmp_dict_1, "22", (long long)(uintptr_t)"SSH", 1); _ks_dict_set(_tmp_dict_1, "23", (long long)(uintptr_t)"Telnet", 1); _ks_dict_set(_tmp_dict_1, "25", (long long)(uintptr_t)"SMTP", 1); _ks_dict_set(_tmp_dict_1, "53", (long long)(uintptr_t)"DNS", 1); _ks_dict_set(_tmp_dict_1, "80", (long long)(uintptr_t)"HTTP", 1); _ks_dict_set(_tmp_dict_1, "110", (long long)(uintptr_t)"POP3", 1); _ks_dict_set(_tmp_dict_1, "111", (long long)(uintptr_t)"RPC", 1); _ks_dict_set(_tmp_dict_1, "135", (long long)(uintptr_t)"MSRPC", 1); _ks_dict_set(_tmp_dict_1, "139", (long long)(uintptr_t)"NetBIOS", 1); _ks_dict_set(_tmp_dict_1, "143", (long long)(uintptr_t)"IMAP", 1); _ks_dict_set(_tmp_dict_1, "443", (long long)(uintptr_t)"HTTPS", 1); _ks_dict_set(_tmp_dict_1, "445", (long long)(uintptr_t)"SMB", 1); _ks_dict_set(_tmp_dict_1, "993", (long long)(uintptr_t)"IMAPS", 1); _ks_dict_set(_tmp_dict_1, "995", (long long)(uintptr_t)"POP3S", 1); _ks_dict_set(_tmp_dict_1, "1723", (long long)(uintptr_t)"PPTP", 1); _ks_dict_set(_tmp_dict_1, "3306", (long long)(uintptr_t)"MySQL", 1); _ks_dict_set(_tmp_dict_1, "3389", (long long)(uintptr_t)"RDP", 1); _ks_dict_set(_tmp_dict_1, "5900", (long long)(uintptr_t)"VNC", 1); _ks_dict_set(_tmp_dict_1, "8080", (long long)(uintptr_t)"HTTP-Proxy", 1); _ks_dict_set(_tmp_dict_1, "8443", (long long)(uintptr_t)"HTTPS-Alt", 1); _tmp_dict_1; });
    return _ks_dict_get_simple(common_services, _ks_str_int(port));
}

static void __method_PortScanner__scan_port__(PortScanner_t* self, long long target, long long port, long long timeout) {
    { /* try */
        long long sock = 0;
        system_socket_settimeout(sock, timeout);
        ks_array _tuple_tmp_0 = {NULL, 0};
        _ks_array_append(&_tuple_tmp_0, (long long)(target));
        _ks_array_append(&_tuple_tmp_0, (long long)(port));
        ks_array _tuple_tmp_1 = {NULL, 0};
        _ks_array_append(&_tuple_tmp_1, (long long)(target));
        _ks_array_append(&_tuple_tmp_1, (long long)(port));
        system_socket_connect(sock, _tuple_tmp_1, ks_int(0LL));
        system_socket_close(sock);
        long long service = _ks__get_service_name(self, port);
        if (ks_v_bool(ks_bool(ks_v_cmp(ks_int(service), ks_none()) == 0))) {
            service = "Unknown";
        }
        long long* _ret_arr_2_ptr = (long long*)calloc(2, sizeof(long long));
        _ret_arr_2_ptr[0] = KS_BOOL(1);
        _ret_arr_2_ptr[1] = service;
        return ks_make_array(_ret_arr_2_ptr, 2);
    } /* end try */
    if (0) { /* except */
        long long* _ret_arr_3_ptr = (long long*)calloc(2, sizeof(long long));
        _ret_arr_3_ptr[0] = KS_BOOL(0);
        _ret_arr_3_ptr[1] = "";
        return ks_make_array(_ret_arr_3_ptr, 2);
    }
}

static char* __method_PortScanner_execute__(PortScanner_t* self) {
    target = _ks_str_at(_ks_str_at(_ks_dict_get_simple(__get_PortScanner_attr_num__(self, "info"), "Options"), (long long)(uintptr_t)"TARGET"), 0LL);
    port_str = _ks_str_at(_ks_str_at(_ks_dict_get_simple(__get_PortScanner_attr_num__(self, "info"), "Options"), (long long)(uintptr_t)"PORTS"), 0LL);
    timeout = ks_int((long long)(atoll(_ks_str_at(_ks_str_at(_ks_dict_get_simple(__get_PortScanner_attr_num__(self, "info"), "Options"), (long long)(uintptr_t)"TIMEOUT"), 0LL))));
    ks_val_t verbose = ks_bool(ks_v_cmp(_ks_str_lower(_ks_str_at(_ks_str_at(_ks_dict_get_simple(__get_PortScanner_attr_num__(self, "info"), "Options"), (long long)(uintptr_t)"VERBOSE"), 0LL)), ks_str(("true"))) == 0);
    char* output_file = _ks_str_at(_ks_str_at(_ks_dict_get_simple(__get_PortScanner_attr_num__(self, "info"), "Options"), (long long)(uintptr_t)"OUTPUT"), 0LL);
    ports = _ks__parse_ports(self, port_str);
    if (__builtin_expect((ks_v_bool(ks_bool(ks_v_cmp(ks_int(ports.length), KS_INT(0LL)) == 0))), 0)) {
        return "[-] No valid ports specified";
    }
    __set_PortScanner_attr__(self, "total_ports", ports.length);
    ks_val_print(ks_str(_ks_concat("[+] Starting port scan on ", ks_val_to_str(ks_int(target))))); printf("\n");
    ks_val_print(ks_str(_ks_concat("[+] Ports to scan: ", _ks_str_int(__get_PortScanner_attr_num__(self, "total_ports"))))); printf("\n");
    ks_val_print(ks_str(_ks_concat(_ks_concat("[+] Timeout: ", _ks_str_int(timeout)), "s"))); printf("\n");
    __set_PortScanner_attr__(self, "open_ports", {});
    __set_PortScanner_attr__(self, "scanned_count", KS_INT(0LL));
    ks_array _iter__idx_port = ports;
    for (long long _idx_port = 0; _idx_port < _iter__idx_port.length; _idx_port++) {
        ...
        long long result = _ks__scan_port(self, target, port, timeout);
        if (ks_v_bool(_ks_dict_get_simple(result, "0"))) {
            _ks_push(__get_PortScanner_attr_num__(self, "open_ports"), {port, _ks_dict_get_simple(result, "1")});
            ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat("[+] Port ", ks_val_to_str(port)), "/tcp OPEN - "), ks_val_to_str(_ks_dict_get_simple(result, "1"))))); printf("\n");
        } else if (ks_v_bool(verbose)) {
            ks_val_print(ks_str(_ks_concat(_ks_concat("[-] Port ", ks_val_to_str(port)), "/tcp closed"))); printf("\n");
        }
        __set_PortScanner_attr__(self, "scanned_count", ks_v_add(ks_int(__get_PortScanner_attr_num__(self, "scanned_count")), KS_INT(1LL)));
    }
    if (ks_v_bool(ks_bool(ks_v_cmp(ks_str((output_file)), ks_str((""))) != 0))) {
        ks_val_t file = open(output_file, "w");
        _ks_write(file, _ks_concat(_ks_concat("Port scan results for ", ks_val_to_str(ks_int(target))), "\n"));
        _ks_write(file, _ks_concat(_ks_concat("Open ports: ", _ks_str_int(__get_PortScanner_attr_num__(self, "open_ports").length)), "\n\n"));
        ks_array _iter_expr_4 = (ks_array)(__get_PortScanner_attr_num__(self, "open_ports"));
        for (long long _idx_item = 0; _idx_item < _iter_expr_4.length; _idx_item++) {
            ks_val_t item = ks_array_get(_iter_expr_4, ks_int((long long)(_idx_item)));
            _ks_write(file, _ks_concat(_ks_concat(_ks_concat(_ks_dict_get_simple(item, "0"), "/tcp - "), ks_val_to_str(_ks_dict_get_simple(item, "1"))), "\n"));
        }
        system_socket_close(file);
    }
    return _ks_concat("[+] Scan completed. Open ports found: ", _ks_str_int(__get_PortScanner_attr_num__(self, "open_ports").length));
}


int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    char* MODULE_TYPE = "auxiliary";
    PortScanner_t* scanner = __new_PortScanner__();
#line 150 "examples/module.ks"
    ks_val_print(__method_PortScanner_get_help__(scanner)); printf("\n");
#line 151 "examples/module.ks"
    ks_val_print(ks_str("")); printf("\n");
#line 152 "examples/module.ks"
    ks_val_print(__method_PortScanner_execute__(scanner)); printf("\n");
    return 0;
}