...
void _ks_init_globals(void) {
    fd = _ks_syscall_open("/sdcard/msg.txt", _ks_as_i(KS_INT(65LL)));
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    _ks_init_globals();
#line 3 "examples/syscall.ks"
    _ks_syscall_write(fd, "gotcha 😹!");
#line 4 "examples/syscall.ks"
    _ks_syscall_fsync(fd);
#line 5 "examples/syscall.ks"
    _ks_syscall_close(fd);
#line 6 "examples/syscall.ks"
    _ks_dict* stats = _ks_syscall_stat("/sdcard/msg.txt");
#line 7 "examples/syscall.ks"
