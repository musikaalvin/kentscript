...
#line 4 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("=== System Information Gatherer ===\n")); printf("\n");
#line 7 "examples/sysinfo_pure.ks"
    _ks_dict* uname = system_platform_uname();
#line 9 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("--- Kernel ---")); printf("\n");
#line 10 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("OS:       ", _ks_dict_to_str(uname, "system")))); printf("\n");
#line 11 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("Node:     ", _ks_dict_to_str(uname, "node")))); printf("\n");
#line 12 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("Release:  ", _ks_dict_to_str(uname, "release")))); printf("\n");
#line 13 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("Version:  ", _ks_dict_to_str(uname, "version")))); printf("\n");
#line 14 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("Machine:  ", _ks_dict_to_str(uname, "machine")))); printf("\n");
#line 17 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("\n--- Identity ---")); printf("\n");
#line 18 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("PID:  ", _ks_str_int(system_os_getpid())))); printf("\n");
#line 19 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("PPID: ", _ks_str_int(system_os_getppid())))); printf("\n");
#line 20 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("UID:  ", _ks_str_int(system_os_getuid())))); printf("\n");
#line 21 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("GID:  ", _ks_str_int(system_os_getgid())))); printf("\n");
#line 22 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("CWD:  ", system_file_getcwd()))); printf("\n");
#line 25 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("\n--- Environment ---")); printf("\n");
#line 26 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("USER:  ", system_os_getenv("USER", "unknown")))); printf("\n");
#line 27 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("HOME:  ", system_os_getenv("HOME", "unknown")))); printf("\n");
#line 28 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("SHELL: ", system_os_getenv("SHELL", "unknown")))); printf("\n");
#line 29 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("LANG:  ", system_os_getenv("LANG", "unknown")))); printf("\n");
#line 32 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("\n--- Network ---")); printf("\n");
#line 33 "examples/sysinfo_pure.ks"
    char* hostname = system_socket_gethostname();
#line 34 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("Hostname: ", hostname))); printf("\n");
#line 35 "examples/sysinfo_pure.ks"
    char* ip = system_socket_gethostbyname(ks_str((hostname)));
#line 36 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("IP:       ", ip))); printf("\n");
#line 39 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("\n--- Resources ---")); printf("\n");
#line 40 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("CPU cores: ", _ks_str_int(system_cpu_count())))); printf("\n");
#line 41 "examples/sysinfo_pure.ks"
    _ks_dict* mem = system_virtual_memory();
#line 42 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("RAM total: ", ks_val_to_str(ks_v_div(ks_int(_ks_dict_get_simple(mem, "total")), KS_INT(1073741824LL)))), " GB"))); printf("\n");
#line 43 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("RAM avail: ", ks_val_to_str(ks_v_div(ks_int(_ks_dict_get_simple(mem, "available")), KS_INT(1073741824LL)))), " GB"))); printf("\n");
#line 44 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("RAM used:  ", _ks_dict_to_str(mem, "percent")), "%"))); printf("\n");
#line 47 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("\n--- Disk (/) ---")); printf("\n");
#line 48 "examples/sysinfo_pure.ks"
    _ks_dict* disk = system_disk_usage("/");
#line 49 "examples/sysinfo_pure.ks"
...
#line 50 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Used:  ", ks_val_to_str(ks_v_div(ks_int(_ks_dict_get_simple(disk, "used")), KS_INT(1073741824LL)))), " GB"))); printf("\n");
#line 51 "examples/sysinfo_pure.ks"
...
#line 52 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat("Use%:  ", _ks_dict_to_str(disk, "percent")), "%"))); printf("\n");
#line 55 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("\n--- Uptime ---")); printf("\n");
#line 56 "examples/sysinfo_pure.ks"
    long long up_secs = system_uptime();
#line 57 "examples/sysinfo_pure.ks"
    ks_val_t up_mins = ks_v_div(ks_int(up_secs), KS_INT(60LL));
#line 58 "examples/sysinfo_pure.ks"
    ks_val_t up_hrs = ks_v_div(up_mins, KS_INT(60LL));
#line 59 "examples/sysinfo_pure.ks"
    ks_val_t up_days = ks_v_div(up_hrs, KS_INT(24LL));
#line 60 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Uptime: ", ks_val_to_str(up_days)), " days, "), ks_val_to_str(ks_v_mod(up_hrs, KS_INT(24LL)))), " hrs, "), ks_val_to_str(ks_v_mod(up_mins, KS_INT(60LL)))), " min"))); printf("\n");
#line 61 "examples/sysinfo_pure.ks"
    ks_array load = system_load_average();
#line 62 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat(_ks_concat(_ks_concat(_ks_concat(_ks_concat("Load:   ", ks_val_to_str(ks_array_get(load, KS_INT(0LL)))), ", "), ks_val_to_str(ks_array_get(load, KS_INT(1LL)))), ", "), ks_val_to_str(ks_array_get(load, KS_INT(2LL)))))); printf("\n");
#line 65 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str("\n--- Report ---")); printf("\n");
#line 66 "examples/sysinfo_pure.ks"
    char* timestamp = system_time_strftime("%Y-%m-%d %H:%M:%S");
#line 67 "examples/sysinfo_pure.ks"
    ks_val_print(ks_str(_ks_concat("Generated: ", timestamp))); printf("\n");
#line 70 "examples/sysinfo_pure.ks"
    char* report = "/tmp/sysinfo_report.txt";
#line 71 "examples/sysinfo_pure.ks"
    char* lines = "System Information Report\n";
    lines = _ks_concat(lines, _ks_concat(_ks_concat("Generated: ", timestamp), "\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat("Hostname:  ", hostname), "\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat("IP:        ", ip), "\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat(_ks_concat(_ks_concat("OS:        ", _ks_dict_to_str(uname, "system")), " "), _ks_dict_to_str(uname, "release")), "\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat("Machine:   ", _ks_dict_to_str(uname, "machine")), "\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat("CPU cores: ", _ks_str_int(system_cpu_count())), "\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat(_ks_concat(_ks_concat("RAM:       ", ks_val_to_str(ks_v_div(ks_int(_ks_dict_get_simple(mem, "total")), KS_INT(1073741824LL)))), " GB  (used "), _ks_dict_to_str(mem, "percent")), "%)\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat(_ks_concat(_ks_concat("Disk /:    ", ks_val_to_str(ks_v_div(ks_int(_ks_dict_get_simple(disk, "total")), KS_INT(1073741824LL)))), " GB  (used "), _ks_dict_to_str(disk, "percent")), "%)\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat("UID:       ", _ks_str_int(system_os_getuid())), "\n"));
    lines = _ks_concat(lines, _ks_concat(_ks_concat("PID:       ", _ks_str_int(system_os_getpid())), "\n"));
#line 82 "examples/sysinfo_pure.ks"
    system_file_write_text(report, lines);
#line 83 "examples/sysinfo_pure.ks"
