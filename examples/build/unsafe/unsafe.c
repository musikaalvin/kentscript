...
int main(int argc, char** argv) {
    ...
    /* unsafe block */
    {
        _ks_outb(hardware, KS_INT(128LL), KS_INT(1019LL));
        _ks_outb(hardware, KS_INT(1LL), KS_INT(1016LL));
        _ks_outb(hardware, KS_INT(0LL), KS_INT(1017LL));
        _ks_outb(hardware, KS_INT(3LL), KS_INT(1019LL));
        _ks_outb(hardware, KS_INT(199LL), KS_INT(1018LL));
        _ks_outb(hardware, KS_INT(72LL), KS_INT(1016LL));
        _ks_outb(hardware, KS_INT(101LL), KS_INT(1016LL));
        _ks_outb(hardware, KS_INT(108LL), KS_INT(1016LL));
        _ks_outb(hardware, KS_INT(108LL), KS_INT(1016LL));
        _ks_outb(hardware, KS_INT(111LL), KS_INT(1016LL));
    }
    return 0;
}