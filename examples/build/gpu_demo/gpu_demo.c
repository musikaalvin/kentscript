...
#line 2 "examples/gpu_demo.ks"
    ks_val_print(ks_str("=== KentScript Real GPU ===")); printf("\n");
#line 3 "examples/gpu_demo.ks"
    char* gname = (ks_gpu_name());
#line 4 "examples/gpu_demo.ks"
    ks_val_print(ks_str(_ks_concat("gpu name: ", gname))); printf("\n");
#line 5 "examples/gpu_demo.ks"
    ks_val_print(ks_str(_ks_concat("gpu available: ", _ks_str_int(((long long)ks_gpu_supported()))))); printf("\n");
#line 6 "examples/gpu_demo.ks"
    ks_val_print(ks_str(_ks_concat("cuda available: ", _ks_str_int(((long long)ks_gpu_cuda_supported()))))); printf("\n");
#line 7 "examples/gpu_demo.ks"
    ks_val_print(ks_str(_ks_concat("cuda name: ", (ks_gpu_cuda_name())))); printf("\n");
#line 9 "examples/gpu_demo.ks"
    ks_val_t n = KS_INT(1024LL);
#line 10 "examples/gpu_demo.ks"
    long long a = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
#line 11 "examples/gpu_demo.ks"
    long long b = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
#line 12 "examples/gpu_demo.ks"
    long long c = (long long)_ks_simd_alloc((size_t)(_ks_as_i(n)) * sizeof(float));
    for (long long i = 0; i < (n).as.i; i++) {
    ((float*)(a))[(i)] = (1.5);
    ((float*)(b))[(i)] = (2.5);
}
#line 19 "examples/gpu_demo.ks"
ks_gpu_f32_binop("+", (float*)(a), (float*)(b), (float*)(c), (_ks_as_i(n)));
#line 20 "examples/gpu_demo.ks"
ks_simd_scale_f32((float*)(c), (2.0), (_ks_as_i(n)));
#line 22 "examples/gpu_demo.ks"
ks_val_t c0 = ks_flt(((float*)(c))[(0LL)]);
#line 23 "examples/gpu_demo.ks"
ks_val_t csum = ks_flt(ks_simd_sum_f32((float*)(c), (_ks_as_i(n))));
#line 24 "examples/gpu_demo.ks"
ks_val_print(ks_str(_ks_concat("c[0] = ", ks_val_to_str(c0)))); printf("\n");
#line 25 "examples/gpu_demo.ks"
ks_val_print(ks_str(_ks_concat("sum  = ", ks_val_to_str(csum)))); printf("\n");
#line 26 "examples/gpu_demo.ks"
ks_val_print(ks_str("exp c[0]=8.0 sum=8192.0")); printf("\n");
#line 28 "examples/gpu_demo.ks"
_ks_simd_free((void*)(a));
#line 28 "examples/gpu_demo.ks"
_ks_simd_free((void*)(b));
#line 28 "examples/gpu_demo.ks"
_ks_simd_free((void*)(c));
#line 29 "examples/gpu_demo.ks"
