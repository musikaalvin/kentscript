...
void _ks_init_globals(void) {
    fd = _ks_syscall_open("/sdcard/mgs.txt", _ks_as_i(KS_INT(438LL)));
}

int main(int argc, char** argv) {
    ks_argc = argc; ks_argv = argv;
    _ks_init_globals();
#line 3 "examples/sys_call.ks"
    _ks_syscall_write(fd, "bursted 😹!");
#line 4 "examples/sys_call.ks"
    _ks_syscall_close(fd);
#line 6 "examples/sys_call.ks"
    _ks_dict* stats = _ks_syscall_stat("/sdcard/mgs.txt");
#line 7 "examples/sys_call.ks"
