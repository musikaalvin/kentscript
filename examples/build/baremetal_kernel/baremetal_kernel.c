...
void serial_write(ks_val_t msg);

#line 3 "examples/baremetal_kernel.ks"
void serial_write(ks_val_t msg) {
...
#line 11 "examples/baremetal_kernel.ks"
void ks_user_main(void) {
    serial_write(ks_str(("KentScript Bare-Metal Kernel\n")));
    serial_write(ks_str(("Running in Ring 0\n")));
    serial_write(ks_str(("Ready!\n")));
}
